...
// $Date: 2009/07/21 $
//////////////////////////////////////////////////////////////////////
#ifndef __SP_GR_EXTENDEDSTATE_H__
#define __SP_GR_EXTENDEDSTATE_H__

#include "sp_gr/shapes/SP_GR_ExtendedDrawnShape.h"

class SP_GR_BaseDrawn;

class SP_GR_ExtendedState: public SP_GR_ExtendedDrawnShape
{
private:
protected:
	virtual bool Draw();
public:
    SP_GR_ExtendedState(SP_DS_Node* p_pcParent,
    ...
    virtual ~SP_GR_ExtendedState();

    virtual SP_Graphic* Clone(SP_Data* p_pcParent);
};

#endif // __SP_GR_EXTENDEDSTATE_H__
