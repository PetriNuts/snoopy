...
bool SP_DS_StSimFAU::AddToSimulationProperties(SP_DLG_SimulationProperties* p_pcDlg, wxSizer* p_pcSizer)
{
	...
	m_pcMaxLambdaTextCtrl = new wxTextCtrl( p_pcDlg, -1, wxString::Format(wxT("%g"), m_nMaxLambda), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pcDeltaTextCtrl = new wxTextCtrl( p_pcDlg, -1, wxString::Format(wxT("%g"), m_nDelta), wxDefaultPosition, wxDefaultSize, 0 );
	l_pcRowSizer->Add(m_pcDeltaTextCtrl, 0, wxALL, 5);
	p_pcSizer->Add(l_pcRowSizer, 1, wxEXPAND | wxALL, 5);

	l_pcRowSizer = new wxBoxSizer( wxHORIZONTAL );
	l_pcRowSizer->Add(new wxStaticText( p_pcDlg, -1, wxT("DeltaB:") ), 1, wxALL | wxEXPAND, 5);
	m_pcDeltaBTextCtrl = new wxTextCtrl( p_pcDlg, -1, wxString::Format(wxT("%g"), m_nDeltaB), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pcTolerenceTextCtrl = new wxTextCtrl( p_pcDlg, -1, wxString::Format(wxT("%g"), m_nTolerance), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pcEpsilonTextCtrl = new wxTextCtrl( p_pcDlg, -1, wxString::Format(wxT("%g"), m_nEpsilon), wxDefaultPosition, wxDefaultSize, 0 );
