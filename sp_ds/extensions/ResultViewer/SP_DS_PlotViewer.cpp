          ...
          m_nMaxYValue(1)
{
    ...
    l_pcAttribute = new SP_DS_ViewerAttributeList(wxT("LEGEND_HORIZONTAL_POS"), wxT("Legend"),
                                                  wxT("Horizontal position"));
    ...
    SP_DS_ViewerAttributeCheckBox *l_pcAttributeCheckBox = new SP_DS_ViewerAttributeCheckBox(wxT("SHOW_X_AXIS"),
                                                                                             wxT("Axes"),
                                                                                             wxT("Show X Axis"));
    m_pcAttributeList->push_back(l_pcAttributeCheckBox);

    SP_DS_ViewerAttributeText *l_pcAttributeTextBox = new SP_DS_ViewerAttributeText(wxT("X_AXIS_LABEL"), wxT("Axes"),
                                                                                    wxT("X Axis Title"));
    ...
    //fixed X axes
    l_pcAttributeCheckBox = new SP_DS_ViewerAttributeCheckBox(wxT("USE_FIXED_X_ADJUSTMENT"), wxT("Fixed"),
                                                              wxT("Fixed X axis adjustment"));
    ...
    //fixed Y axes
    l_pcAttributeCheckBox = new SP_DS_ViewerAttributeCheckBox(wxT("USE_FIXED_Y_ADJUSTMENT"), wxT("Fixed"),
                                                              wxT("Fixed Y axis adjustment"));
...
void SP_DS_PlotViewer::UpdateAttributes() {
    ...
    if (GetAttributeByName(wxT("WINDOW_HEIGHT")) != NULL) {
        m_WindowHeight = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("WINDOW_HEIGHT"))))->GetValueString();
    }
    if (GetAttributeByName(wxT("WINDOW_WIDTH")) != NULL) {
        m_WindowWidth = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("WINDOW_WIDTH"))))->GetValueString();
    }


    // export image height and width
    if (GetAttributeByName(wxT("CHART_HEIGHT")) != NULL) {
        m_ChartHeight = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("CHART_HEIGHT"))))->GetValueString();
    }
    if (GetAttributeByName(wxT("CHART_WIDTH")) != NULL) {
        m_ChartWidth = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("CHART_WIDTH"))))->GetValueString();
    }

    //Show legend
    if (GetAttributeByName(wxT("SHOW_LEGEND")) != NULL) {
        m_bShowLegend = (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(
                wxT("SHOW_LEGEND"))))->GetValue();
    }
    ...
    if (GetAttributeByName(wxT("SHOW_X_AXIS")) != NULL) {
        m_bShowXAxis = (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(
                wxT("SHOW_X_AXIS"))))->GetValue();
    }

    //Show Y Axis
    if (GetAttributeByName(wxT("SHOW_Y_AXIS")) != NULL) {
        m_bShowYAxis = (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(
                wxT("SHOW_Y_AXIS"))))->GetValue();
    }

    //X Axis Title
    if (GetAttributeByName(wxT("X_AXIS_LABEL")) != NULL) {
        m_sXAxisTitle = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("X_AXIS_LABEL"))))->GetValueString();
    }

    //Y Axis Title
    if (GetAttributeByName(wxT("Y_AXIS_LABEL")) != NULL) {
        m_sYAxisTitle = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("Y_AXIS_LABEL"))))->GetValueString();
    }
    ...
    if (GetAttributeByName(wxT("USE_FIXED_X_ADJUSTMENT")) != NULL) {
        m_bFixedXAdjustment = (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(
                wxT("USE_FIXED_X_ADJUSTMENT"))))->GetValue();
    }

    //fixed adjustment
    if (GetAttributeByName(wxT("USE_FIXED_Y_ADJUSTMENT")) != NULL) {
        m_bFixedYAdjustment = (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(
                wxT("USE_FIXED_Y_ADJUSTMENT"))))->GetValue();
    }

    //Min. X
    if (GetAttributeByName(wxT("MIN_X_VALUE")) != NULL) {
        wxString l_sMinX = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("MIN_X_VALUE"))))->GetValueString();
    ...
    if (GetAttributeByName(wxT("MAX_X_VALUE")) != NULL) {
        wxString l_sMaxX = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("MAX_X_VALUE"))))->GetValueString();
    ...
    if (GetAttributeByName(wxT("MIN_Y_VALUE")) != NULL) {
        wxString l_sMinY = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("MIN_Y_VALUE"))))->GetValueString();
    ...
    if (GetAttributeByName(wxT("MAX_Y_VALUE")) != NULL) {
        wxString l_sMaxY = (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(
                wxT("MAX_Y_VALUE"))))->GetValueString();
...
void SP_DS_PlotViewer::LoadCurrentAttributeValues() {
    ...
    if (GetAttributeByName(wxT("WINDOW_HEIGHT")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("WINDOW_HEIGHT"))))->SetValueString(
                m_WindowHeight);
    }
    if (GetAttributeByName(wxT("WINDOW_WIDTH")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("WINDOW_WIDTH"))))->SetValueString(
                m_WindowWidth);
    }
    ...
    if (GetAttributeByName(wxT("CHART_HEIGHT")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("CHART_HEIGHT"))))->SetValueString(
                m_ChartHeight);
    }
    if (GetAttributeByName(wxT("CHART_WIDTH")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("CHART_WIDTH"))))->SetValueString(
                m_ChartWidth);
    }
    //Show legend
    if (GetAttributeByName(wxT("SHOW_LEGEND")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(wxT("SHOW_LEGEND"))))->SetValue(
                m_bShowLegend);
    }
    ...
    //X Axis Title
    if (GetAttributeByName(wxT("X_AXIS_LABEL")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("X_AXIS_LABEL"))))->SetValueString(
                m_sXAxisTitle);
    }

    //Y Axis Title
    if (GetAttributeByName(wxT("Y_AXIS_LABEL")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeText *>(GetAttributeByName(wxT("Y_AXIS_LABEL"))))->SetValueString(
                m_sYAxisTitle);
    }
    ...
    //fixed symbols
    if (GetAttributeByName(wxT("USE_FIXED_X_ADJUSTMENT")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(wxT("USE_FIXED_X_ADJUSTMENT"))))->SetValue(
                m_bFixedXAdjustment);
    }

    //fixed symbols
    if (GetAttributeByName(wxT("USE_FIXED_Y_ADJUSTMENT")) != NULL) {
        (dynamic_cast<SP_DS_ViewerAttributeCheckBox *>(GetAttributeByName(wxT("USE_FIXED_Y_ADJUSTMENT"))))->SetValue(
                m_bFixedYAdjustment);
    }
...
void SP_DS_PlotViewer::SaveViewToSnoopyFormat(SP_DS_Metadata *p_pcView) {
    ...
    l_pcAttribute = p_pcView->GetAttribute(wxT("ChartWidth"));
    CHECK_POINTER(l_pcAttribute, return);
    l_pcAttribute->SetValueString(m_ChartWidth);

    l_pcAttribute = p_pcView->GetAttribute(wxT("ChartHeight"));
    CHECK_POINTER(l_pcAttribute, return);
...
void SP_DS_PlotViewer::LoadViewFromSnoopyFormat(SP_DS_Metadata *p_pcView) {
    ...
    l_pcAttribute = p_pcView->GetAttribute(wxT("ChartWidth"));
    CHECK_POINTER(l_pcAttribute, return);
    m_ChartWidth = l_pcAttribute->GetValueString();
