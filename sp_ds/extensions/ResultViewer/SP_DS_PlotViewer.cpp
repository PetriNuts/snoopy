...
void SP_DS_PlotViewer::UpdateAttributes()
{
		  ...
		  {
			  m_ChartWidth=(dynamic_cast<SP_DS_ViewerAttributeText*>(GetAttributeByName(wxT("CHART_WIDTH"))))->GetValueString();
		  }
...
void SP_DS_PlotViewer::LoadCurrentAttributeValues()
{
          ...
          if(GetAttributeByName(wxT("CHART_HEIGHT"))!=NULL)
		  {
				(dynamic_cast<SP_DS_ViewerAttributeText*>(GetAttributeByName(wxT("CHART_HEIGHT"))))->SetValueString(m_ChartHeight);
		  }
          if(GetAttributeByName(wxT("CHART_WIDTH"))!=NULL)
		  {
				(dynamic_cast<SP_DS_ViewerAttributeText*>(GetAttributeByName(wxT("CHART_WIDTH"))))->SetValueString(m_ChartWidth);
		  }
          //Show legend
		if(GetAttributeByName(wxT("SHOW_LEGEND"))!=NULL)
		{
