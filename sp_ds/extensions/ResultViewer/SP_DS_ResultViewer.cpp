...
void SP_DS_ResultViewer::AddCurve(const wxString& p_sCurveName,const unsigned long& p_nDataColumn,
		                          const SP_Vector2DDouble*  p_pcResultMatrix,
		                          const wxString& p_sColor,const int& p_nLineWidth,
