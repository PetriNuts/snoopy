...
private:
	...
	bool GetColoredPlaces(wxString p_sFormula,SP_DS_Node* p_pcNode,map<wxString, SP_ColPN_RateFunction>* p_pmColPlace2Color);

public:
	bool CheckColoredRateFunction(wxString p_sCheckFormula,SP_DS_Node* p_pcNode);
	bool ProceedRateFunction(wxString &p_sRateFunction, SP_DS_Node* p_pcNode, map<wxString, SP_ColPN_RateFunction>* p_pmColPlace2Color);
	bool ReplaceRateFunction(wxString &p_sFormula,map<wxString, SP_ColPN_RateFunction>* p_pmColPlace2Color, bool p_bExport = false);
