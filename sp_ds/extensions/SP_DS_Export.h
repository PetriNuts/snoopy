...
#ifndef SP_DS_EXPORT_H_
#define SP_DS_EXPORT_H_
#include <wx/wx.h>
...
{
public:
	SP_DS_PedAnimation *m_pc_Animator; //To store the current animation window object
	...
	Export(const wxString &, class SP_DS_PedAnimation *);
