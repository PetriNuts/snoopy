...
SP_DS_ColTraceAnalyzer::SP_DS_ColTraceAnalyzer( SP_DS_ColPN_Unfolding* p_pcUnfolding, const SP_Vector2DDouble& p_aanResults,
												  SP_Vector2DDouble& p_aanUserResults, vector<wxString>&  p_vUserVariable) 
		:m_pcUnfolding(p_pcUnfolding),
...
bool SP_DS_ColTraceAnalyzer::GetUnfoldData()
{
	m_pvsColoredPlaceNames =  m_pcUnfolding->GetColoredPlaceNames();	
	...
	m_pnsPlaceCountById = m_pcUnfolding->GetPlaceCountById();

	m_pvsUnPlaceNames = m_pcUnfolding->GetPlaceNames();	

	m_pmsColPlName2ColSet = m_pcUnfolding->GetColPlName2ColSet();

	m_pvsPlaceColor = m_pcUnfolding->GetColorsOfPlace();

	m_pcColorSetClass = m_pcUnfolding->GetColorSetClass();	

	return true;
}


bool SP_DS_ColTraceAnalyzer::Compute()
{
...
void SP_DS_ColTraceAnalyzer::ReverseMatrix()
{
...
SP_ColPN_NeighborDim SP_DS_ColTraceAnalyzer::GetPredicateType(wxString p_sPredicate)
{
...
bool SP_DS_ColTraceAnalyzer::ProcessSelPlaces(wxString p_sSelColPlaceName)
{
...
bool SP_DS_ColTraceAnalyzer::ComputeGeneral()
{
...
bool SP_DS_ColTraceAnalyzer::GetSumSelUnPlaces(vector<long>& p_vSelPlPos)
{
...
//for the special function Neighbor1D and Neighbor2D
//for 1D and 2D
bool SP_DS_ColTraceAnalyzer::ComputeNeighborNumber()
{
	unsigned long l_nTimePointCount = m_aanResults.size();
...
bool SP_DS_ColTraceAnalyzer::GetCellNeighbors(map<wxString, bool> &p_mCellExistToken)
{
...
bool SP_DS_ColTraceAnalyzer::Match(wxString p_sCell, wxString p_sNBCell)
{
...
bool SP_DS_ColTraceAnalyzer::ProcessPredicate()
{
...
bool SP_DS_ColTraceAnalyzer::SumNeighbors()
{
