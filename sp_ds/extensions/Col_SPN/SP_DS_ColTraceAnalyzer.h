...
#ifndef __SP_DS_ColTraceAnalyzer__
#define __SP_DS_ColTraceAnalyzer__
...
class SP_DS_ColTraceAnalyzer
{
  ...
  public:	
    SP_DS_ColTraceAnalyzer(SP_DS_ColPN_Unfolding* p_pcUnfolding, const SP_Vector2DDouble& p_aanResults, SP_Vector2DDouble& p_aanUserResults, vector<wxString>&  p_vUserVariable);

	bool Compute();

};

#endif // __SP_DS_ColTraceAnalyzer__
