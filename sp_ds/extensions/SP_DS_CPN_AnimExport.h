...
#ifndef SP_DS_EXPORT_ANIM_CPN_H_
#define SP_DS_EXPORT_ANIM_CPN_H_
#include <wx/wx.h>
...
class ExportCPN : public wxFrame
{
public:
	SP_DS_CPN_Animation *m_pc_Animator; //To store the current animation window object
									   //SP_DS_CPN_Animation* m_pcCpnAnimator;
	wxPanel *m_pc_Panel;
	...
	ExportCPN(const wxString &, class SP_DS_CPN_Animation * );
...
#endif /* SP_DS_EXPORT_ANIM_CPN_H_ */
