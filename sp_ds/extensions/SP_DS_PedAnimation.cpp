...
bool SP_DS_PedAnimation::AddToControl(SP_DLG_Animation* p_pcCtrl, wxSizer* p_pcSizer)
{
	...
	m_pcStepCounter->Add(m_pcStepCounterText,1,wxEXPAND | wxALL | wxALIGN_CENTER_HORIZONTAL,5);
	m_pcStepCounter->Add(m_pcStepCounterValue,1,wxEXPAND | wxALL | wxALIGN_CENTER_HORIZONTAL,5);
