...
// Short Description:
//////////////////////////////////////////////////////////////////////
#ifndef __SP_DS_SIMPLEPED_H__
#define __SP_DS_SIMPLEPED_H__

#include "sp_ds/netclasses/SP_DS_BipartGraph.h"

class SP_DS_SimplePed: public SP_DS_BipartGraph
{
private:
protected:
public:
    SP_DS_SimplePed();
    SP_DS_SimplePed(const wxString& p_pchName);
