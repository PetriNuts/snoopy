//note: for details see RFC 1321

//constants
#define MD5_INIT1 0x67452301
#define MD5_INIT2 0xefcdab89
#define MD5_INIT3 0x98badcfe
#define MD5_INIT4 0x10325476
...
#define OP(f,a,b,c,d,k,s,t) ((a) = (b) + ROTATE_LEFT((a) + f((b),(c),(d)) + (k) + (t), (s)))
