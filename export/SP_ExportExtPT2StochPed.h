...
// $Version: 0.0 $
// $Revision: 1.30 $
// $Date: 2009/04/23 12:20:00 $
//////////////////////////////////////////////////////////////////////
#ifndef __SP_EXPORTEXTPT2STOCHPED_H__
#define __SP_EXPORTEXTPT2STOCHPED_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportExtPT2StochPed: public SP_XmlWriter, public SP_ExportRoutine
{
  private:
  ...
  public:
    ...
    inline virtual wxString GetDescr()
      { return wxT("Export an Extended Petri Net into Stochastic Petri Net Format"); }
...
#endif // __SP_EXPORTEXTPT2STOCHPED_H__
