...
bool SP_ExportPed2StochPed::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportPed2StochPed::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
	CHECK_POINTER(p_doc, return false);
	CHECK_POINTER(p_doc->GetGraph(), return false);
...
bool SP_ExportPed2StochPed::WriteNetclass(SP_DS_Netclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportPed2StochPed::WriteNodeclass(SP_DS_Nodeclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportPed2StochPed::WriteStochTransition(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE);
	CHECK_POINTER( p_pcRoot, return FALSE);
