...
#ifndef __SP_ExportColHPN2ColPN_H__
#define __SP_ExportColHPN2ColPN_H__

#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_XmlWriter.h"

class SP_ExportColHPN2ColPN:  public SP_ExportRoutine, private SP_XmlWriter
{
 ...
 public:
  ...
  inline virtual wxString GetDescr()
    { return wxT("Export a Colored Hybrid Petri Net into Colored Petri Net Format");}
...
#endif // __SP_ExportColHPN2ColPN_H__
