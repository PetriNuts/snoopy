...
bool SP_ExportColHPN2ColPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColHPN2ColPN::Write(SP_MDI_Doc* p_doc,
...
bool SP_ExportColHPN2ColPN::WriteNetclass(SP_DS_Netclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColHPN2ColPN::WriteNodeclass(SP_DS_Nodeclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );	
...
bool SP_ExportColHPN2ColPN::WritePlace(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );	
...
bool SP_ExportColHPN2ColPN::WriteTransition(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );	
...
bool SP_ExportColHPN2ColPN::WriteParameter(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColHPN2ColPN::WriteEdgeclass(SP_DS_Edgeclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);	
...
bool
SP_ExportColHPN2ColPN::WriteEdge(SP_DS_Edge* p_pcVal, wxXmlNode* p_pcRoot)
{
    CHECK_POINTER(p_pcVal, return FALSE);
    CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColHPN2ColPN::WriteEdgeGraphic(SP_GR_Edge* p_pcVal,
				     wxXmlNode* p_pcRoot)
{
  ...
  { // write our own colors
   ...
   if( m_edgeClass == wxT("Edge") )
    ...
    if (m_edgeClass == wxT("Read Edge") )
	     colour=wxT("255,100,255");

	if(m_edgeClass == wxT("Inhibitor Edge") )
	    colour=wxT("255,50,255");
