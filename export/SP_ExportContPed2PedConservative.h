...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_EXPORTCONTPED2PEDCONSERVATIVE_H__
#define __SP_EXPORTCONTPED2PEDCONSERVATIVE_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportContPed2PedConservative: public SP_XmlWriter, public SP_ExportRoutine
{
private:
protected:
  SP_MDI_Doc* m_doc;
...
public:
  ...
  inline virtual wxString GetName()
    { return wxT("Export to Discrete Petri Net - remove inhibitor and test edges");}
...
#endif // __SP_EXPORTCONTPED2PEDCONSERVATIVE_H__
