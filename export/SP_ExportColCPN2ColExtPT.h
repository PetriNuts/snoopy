...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_ExportColCPN2ColExtPT_H__
#define __SP_ExportColCPN2ColExtPT_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportColCPN2ColExtPT: public SP_XmlWriter, public SP_ExportRoutine
{
private:
protected:
  SP_MDI_Doc* m_doc;
  ...
  //bool WriteStochParameter( SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot);
...
public:
  ...
  inline virtual wxString GetDescr()
    { return wxT("Export a Colored Continuous Petri Net into Colored Extended Petri Net Format");}
...
#endif // __SP_ExportColCPN2ColExtPT_H__
