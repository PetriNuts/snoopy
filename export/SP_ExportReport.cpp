...
SP_ExportReport::SP_ExportReport()
{
	//General tab options
...
bool
SP_ExportReport::AddToDialog(SP_DLG_ExportProperties* p_pcDlg, SP_MDI_Doc* p_pcDoc)
{
...
bool
SP_ExportReport::OnDialogOk()
{
	return true;
}

bool
SP_ExportReport::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool
SP_ExportReport::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
  CHECK_POINTER(p_doc, return FALSE);
...
void
SP_ExportReport::Declarations_UpdateUI(wxUpdateUIEvent& p_cEvent)
{
...
void
SP_ExportReport::Graph_UpdateUI(wxUpdateUIEvent& p_cEvent)
{
...
SP_ExportReport::AddGeneral()
{
	...
	m_pcCheckBoxDirectPDF->Bind(wxEVT_CHECKBOX, &SP_ExportReport::OnClickGeneratePDF, this, SP_GENERATEPDF_CHECKBOX_SELECTED);
	...
	m_rbPdfLatex->Bind(wxEVT_RADIOBUTTON, &SP_ExportReport::OnSelectLatexCompiler_Pdflatex, this, SP_ID_GENERAL_PDFLATEX);
	m_rbLatexmk->Bind(wxEVT_RADIOBUTTON, &SP_ExportReport::OnSelectLatexCompiler_Latexmk, this, SP_ID_GENERAL_LATEXMK);
...
SP_ExportReport::AddBasics()
{
	...
	m_pcRearrangelist_basics->Bind(wxEVT_LISTBOX, &SP_ExportReport::OnSelChange_Basics, this, SP_ID_BASICS_UPDATE);
	m_pcRearrangelist_basics->Bind(wxEVT_CHECKLISTBOX, &SP_ExportReport::OnCheckUncheck_Basics, this, SP_ID_BASICS_UPDATE);

	l_pcButtonUp->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Basics_UpdateUI, this, SP_ID_BUTTON_BASICS_UP);
	l_pcButtonDown->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Basics_UpdateUI, this, SP_ID_BUTTON_BASICS_DOWN);

	l_pcButtonUp->Bind(wxEVT_BUTTON, &SP_ExportReport::Basics_Move, this, SP_ID_BUTTON_BASICS_UP);
	l_pcButtonDown->Bind(wxEVT_BUTTON, &SP_ExportReport::Basics_Move, this, SP_ID_BUTTON_BASICS_DOWN);
...
bool
SP_ExportReport::AddAttributes_GraphElements()
{
	...
	for (itN = SP_Node2Attributes.begin(); itN != SP_Node2Attributes.end(); itN++)
	{
	    ...
	    if( (!edgeclass) && l_sCurrentNode.Cmp("Comment") )  //if not an edge or comment (in metadata)
	    {
	        ...
	        l_pcTextCtrl->Bind(wxEVT_TEXT, &SP_ExportReport::OnRegEx_Graph, this, SP_REGEX_GRAPH);
			...
			l_pcSelectClearAllChkBox->Bind(wxEVT_CHECKBOX, &SP_ExportReport::OnSelectClearAllItems_Graph, this,
					SP_ID_BUTTON_SELECT_CLEAR_ALL_ITEMS_GRAPH);
...
void
SP_ExportReport::AddGraphElements()
{
	...
	m_pcRearrangelist_Graph->Bind(wxEVT_LISTBOX, &SP_ExportReport::OnSelChange_Graph, this, SP_ID_GRAPH_UPDATE);
	//m_pcRearrangelist_Graph->Bind(wxEVT_CHECKLISTBOX, &SP_ExportReport::OnCheckUncheck_Graph, this, SP_ID_GRAPH_UPDATE);

	m_pcGraph_ButtonUp->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Graph_UpdateUI, this, SP_ID_BUTTON_GRAPH_UP);
	m_pcGraph_ButtonDown->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Graph_UpdateUI, this, SP_ID_BUTTON_GRAPH_DOWN);

	m_pcGraph_ButtonUp ->Bind(wxEVT_BUTTON, &SP_ExportReport::Graph_Move, this, SP_ID_BUTTON_GRAPH_UP);
	m_pcGraph_ButtonDown->Bind(wxEVT_BUTTON, &SP_ExportReport::Graph_Move, this, SP_ID_BUTTON_GRAPH_DOWN);
...
bool
SP_ExportReport::AddAttributes_Declarations()
{
	map<int, wxArrayString >::const_iterator itN;
	SP_DecNode2NodeCheckList.clear();
	SP_DecNode2SelectClearAllCheckBox.clear();
	...
	for (itN = SP_DecNode2Attributes.begin(); itN != SP_DecNode2Attributes.end(); itN++)
    {
		...
		l_pcTextCtrl->Bind(wxEVT_TEXT, &SP_ExportReport::OnRegEx_Dec, this, SP_REGEX_DEC);
		...
		l_pcSelectClearAllChkBox->Bind(wxEVT_CHECKBOX, &SP_ExportReport::OnSelectClearAllItems_Dec, this, SP_ID_BUTTON_SELECT_CLEAR_ALL_ITEMS_DEC);
...
void
SP_ExportReport::AddDeclarations()
{
	...
	m_pcRearrangelist_declarations->Bind(wxEVT_LISTBOX, &SP_ExportReport::OnSelChange_Declarations, this, SP_ID_DECLARATIONS_UPDATE);
	//m_pcRearrangelist_declarations->Bind(wxEVT_CHECKLISTBOX, &SP_ExportReport::OnCheckUncheck_Declarations, this, SP_ID_DECLARATIONS_UPDATE);

	m_pcDeclarations_ButtonUp->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Declarations_UpdateUI, this, SP_ID_BUTTON_DECLARATIONS_UP);
	m_pcDeclarations_ButtonDown->Bind(wxEVT_UPDATE_UI, &SP_ExportReport::Declarations_UpdateUI, this, SP_ID_BUTTON_DECLARATIONS_DOWN);

	m_pcDeclarations_ButtonUp->Bind(wxEVT_BUTTON, &SP_ExportReport::Declarations_Move, this, SP_ID_BUTTON_DECLARATIONS_UP);
	m_pcDeclarations_ButtonDown->Bind(wxEVT_BUTTON, &SP_ExportReport::Declarations_Move, this, SP_ID_BUTTON_DECLARATIONS_DOWN);
...
void
SP_ExportReport::copyTree_recur(const wxTreeItemId& into, const wxTreeItemId& from, wxString label, int id)
{
	if(!from.IsOk() ) { return; }
...
void
SP_ExportReport::OnClickGeneratePDF(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::Basics_UpdateUI(wxUpdateUIEvent& p_cEvent)
{
...
void
SP_ExportReport::Basics_Move(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::Graph_Move(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::Declarations_Move(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::AddAttributes_BasicsGeneral()
{
...
void
SP_ExportReport::AddAttributes_BasicsNet()
{
...
void
SP_ExportReport::AddAttributes_BasicsLayout()
{
...
void
SP_ExportReport::AddAttributes_BasicsTypography()
{
...
void
SP_ExportReport::UpdateRightPanel_Basics(int id)
{
	switch( id ) {
...
void
SP_ExportReport::UpdateRightPanel_Graph( int id )
{
...
void
SP_ExportReport::UpdateRightPanel_Declarations(int id)
{
...
void
SP_ExportReport::OnSelChange_Basics(wxCommandEvent& p_cEvent)
{
	UpdateRightPanel_Basics( m_pcRearrangelist_basics->GetCurrentOrder()[ p_cEvent.GetInt() ] );
}

void
SP_ExportReport::OnCheckUncheck_Basics(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnSelChange_Graph(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnCheckUncheck_Graph(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnSelChange_Declarations(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnCheckUncheck_Declarations(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnSelectClearAllItems_Graph(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnSelectClearAllItems_Dec(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnRegEx_Graph(wxCommandEvent& p_cEvent)
{
	int id = m_nSelectionId_Graph;
	wxRegEx l_cRegEx;
...
void
SP_ExportReport::OnRegEx_Dec(wxCommandEvent& p_cEvent)
{
	int id = m_nSelectionId_Declarations;
	wxRegEx l_cRegEx;
...
wxTreeItemId
SP_ExportReport::FindTreeItemRec(const wxTreeItemId& p_Id, wxString label)
{
  wxTreeItemIdValue cookie= NULL;
...
bool
SP_ExportReport::StartDoc(const wxString& p_fileName)
{
	m_bitmapCount = 0;
...
bool
SP_ExportReport::WriteTitlePage()
{
...
bool
SP_ExportReport::WriteGraphElements()
{
...
bool
SP_ExportReport::WriteDeclarations_Colored()
{
...
bool
SP_ExportReport::WriteDeclarations()
{
	const wxString latexDec_file = m_sFilePath + wxT("Declarations.tex");
	SP_LOGMESSAGE( latexDec_file );
...
void
SP_ExportReport::WriteHierarchyTreeRecur(const wxTreeItemId& p_Id, FILE* l_pstream, int &p_nChildCount)
{
	if(!p_Id.IsOk() ) { return; }
...
bool
SP_ExportReport::WriteHierarchyTree(FILE* l_pstream)
{
...
void
SP_ExportReport::WriteHierarchyFigureRec(const wxTreeItemId& p_Id, FILE* l_pstream)
{
	if(!p_Id.IsOk() ) { return; }
...
bool
SP_ExportReport::WriteHierarchyFigure(FILE* l_pstream)
{
...
bool
SP_ExportReport::IsAncestorSelected(const wxTreeItemId& tree_item)
{
...
bool
SP_ExportReport::WriteHierarchy()
{
...
bool
SP_ExportReport::WriteReferences()
{
...
bool
SP_ExportReport::SetUpPrintData(wxPrintData& pd, const wxString& p_fileName)
{
...
wxString
SP_ExportReport::EditStringforLatex(wxString filename,  bool remove_space)
{
...
wxString
SP_ExportReport::EditStringforCrossRef(wxString filename)
{
	for(int i = 0; i < filename.length(); i++) {
...
void
SP_ExportReport::OnSelectLatexCompiler_Pdflatex(wxCommandEvent& p_cEvent)
{
...
void
SP_ExportReport::OnSelectLatexCompiler_Latexmk(wxCommandEvent& p_cEvent)
{
