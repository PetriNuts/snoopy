...
SP_ExportColExtPT2CSV::SP_ExportColExtPT2CSV()
{
}
...
bool SP_ExportColExtPT2CSV::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColExtPT2CSV::DoWrite()
{
	WriteDeclarations();
...
bool SP_ExportColExtPT2CSV::WritePlaces()
{
...
bool SP_ExportColExtPT2CSV::WriteTransitions()
{
