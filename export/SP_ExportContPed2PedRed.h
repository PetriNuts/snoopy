...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_EXPORTCONTPED2PEDRED_H__
#define __SP_EXPORTCONTPED2PEDRED_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportContPed2PedRed: public SP_XmlWriter, public SP_ExportRoutine
{
private:
protected:
  SP_MDI_Doc* m_doc;
...
public:
  ...
  inline virtual wxString GetName()
    { return wxT("Export to Discrete Petri Net - draw test and inhibitor edges red");}
...
#endif // __SP_EXPORTCONTPED2PEDRED_H__
