...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_ExportColCPN2ContPed_H__
#define __SP_ExportColCPN2ContPed_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_Vector.h"

class SP_ExportColCPN2ContPed: public SP_XmlWriter, public SP_ExportRoutine
{
...
private:	
  ...
  public:
    ...
    inline virtual wxString GetDescr()
      { return wxT("Export a Colored Continuous Petri Net into Continuous Petri Net Format"); }

    virtual wxString GetExtension()
      { return wxT("cpn"); }

    virtual wxString GetFileDescr()
      { return wxT("Continuous PT Net Files"); }

};

#endif // __SP_ExportColCPN2ContPed_H__
