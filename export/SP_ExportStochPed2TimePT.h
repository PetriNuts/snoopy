...
#ifndef __SP_ExportStochPed2TimePT_H__
#define __SP_ExportStochPed2TimePT_H__

#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_XmlWriter.h"

class SP_ExportStochPed2TimePT:  public SP_ExportRoutine, private SP_XmlWriter
{
 ...
 public:
  ...
  inline virtual wxString GetName()
    { return wxT("Export to Time Petri Net");}
  inline virtual wxString GetDescr()
    { return wxT("Export a Stochastic Petri Net into Time Petri Net Format");}
  virtual wxString GetExtension()
    { return wxT("tpn");}
  virtual wxString GetFileDescr()
    { return wxT("Time Petri Net Files");}
...
#endif // __SP_ExportStochPed2TimePT_H__
