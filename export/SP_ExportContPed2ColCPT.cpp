...
bool SP_ExportContPed2ColCPT::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportContPed2ColCPT::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
	CHECK_POINTER(p_doc, return false);
	CHECK_POINTER(p_doc->GetGraph(), return false);
	...
	/////////////////////////////////
	////constants
	SP_ListMetadata l_pcListConst;//to be deleted after exporting, becauase we do not need them anymore as they belong only to the coloured stuff
...
bool SP_ExportContPed2ColCPT::WriteNetclass(SP_DS_Netclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportContPed2ColCPT::WriteNodeclass(SP_DS_Nodeclass* p_pcVal, wxXmlNode* p_pcRoot )
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );
...
bool
SP_ExportContPed2ColCPT::WriteEdgeclass(SP_DS_Edgeclass* p_pcVal, wxXmlNode* p_pcRoot)
{
    CHECK_POINTER(p_pcVal, return FALSE);
    CHECK_POINTER(p_pcRoot, return FALSE);
...
bool SP_ExportContPed2ColCPT::WriteExtPlace(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot )
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );
...
bool SP_ExportContPed2ColCPT::WriteExtTransition(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot )
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );
...
bool SP_ExportContPed2ColCPT::WriteExtEdge( SP_DS_Edge* p_pcVal, wxXmlNode* p_pcRoot )
{
	CHECK_POINTER(p_pcVal, return FALSE);
    CHECK_POINTER(p_pcRoot, return FALSE);
