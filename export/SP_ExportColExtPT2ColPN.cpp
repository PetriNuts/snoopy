...
bool SP_ExportColExtPT2ColPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColExtPT2ColPN::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
	CHECK_POINTER(p_doc, return false);
	CHECK_POINTER(p_doc->GetGraph(), return false);
...
bool SP_ExportColExtPT2ColPN::WriteNetclass(SP_DS_Netclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool
SP_ExportColExtPT2ColPN::WriteEdgeclass(SP_DS_Edgeclass* p_pcVal,
				   wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return false);
	CHECK_POINTER(p_pcRoot, return false);
...
bool
SP_ExportColExtPT2ColPN::WriteEdgeGraphic(SP_GR_Edge* p_pcVal,
				     wxXmlNode* p_pcRoot)
{
...
bool
SP_ExportColExtPT2ColPN::WriteEdge(SP_DS_Edge* p_pcVal,
					wxXmlNode* p_pcRoot)
{
    CHECK_POINTER(p_pcVal, return FALSE);
    CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColExtPT2ColPN::WriteAttribute( SP_DS_Attribute* p_pcVal, wxXmlNode* p_pcRoot )
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColExtPT2ColPN::WriteColourInformation(SP_Graphic* p_pcVal,
					   wxXmlNode* p_pcNode)
{
	CHECK_POINTER(p_pcVal, return FALSE);
