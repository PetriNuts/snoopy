...
// $Date: 2009/11/9 $
//////////////////////////////////////////////////////////////////////
#ifndef __SP_ExportPed2ColPT_H__
#define __SP_ExportPed2ColPT_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportPed2ColPT: public SP_XmlWriter, public SP_ExportRoutine
{
  private:
  ...
  public:
    ...
    inline virtual wxString GetDescr()
      { return wxT("Export a Petri Net into Colored Petri Net Format"); }

    virtual wxString GetExtension()
      { return wxT("colpn"); }

    virtual wxString GetFileDescr()
      { return SP_DS_COLPN_CLASS; }

};

#endif // __SP_ExportPed2ColPT_H__
