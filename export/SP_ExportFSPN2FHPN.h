...
*/
//======================================================================================
#ifndef SP_EXPORTFSPN2FHPN_H_
#define SP_EXPORTFSPN2FHPN_H_

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"
#include "sp_gr/attributes/SP_GR_ColListAttribute.h"

class SP_ExportFSPN2FHPN : public SP_XmlWriter, public SP_ExportRoutine
{
private:
