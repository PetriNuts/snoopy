...
bool SP_ExportColSPN2ColHPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColSPN2ColHPN::Write(SP_MDI_Doc* p_doc,
...
bool SP_ExportColSPN2ColHPN::WriteNetclass(SP_DS_Netclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColSPN2ColHPN::WriteNodeclass(SP_DS_Nodeclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );	
...
bool SP_ExportColSPN2ColHPN::WritePlace(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColSPN2ColHPN::WriteTransition(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER( p_pcVal, return FALSE );
	CHECK_POINTER( p_pcRoot, return FALSE );	
...
bool SP_ExportColSPN2ColHPN::WriteParameter(SP_DS_Node* p_pcVal,
		wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColSPN2ColHPN::WriteEdgeclass(SP_DS_Edgeclass* p_pcVal,
		wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColSPN2ColHPN::WriteEdge(SP_DS_Edge* p_pcVal, wxXmlNode* p_pcRoot)
{
    CHECK_POINTER(p_pcVal, return FALSE);
    CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColSPN2ColHPN::WriteEdgeGraphic(SP_GR_Edge* p_pcVal,
				     wxXmlNode* p_pcRoot)
{
...
bool
SP_ExportColSPN2ColHPN::WriteColourInformation(SP_Graphic* p_pcVal,
					   wxXmlNode* p_pcNode)
{
  CHECK_POINTER(p_pcVal, return FALSE);
