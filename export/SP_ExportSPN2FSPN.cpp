...
bool SP_ExportSPN2FSPN::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
...
bool SP_ExportSPN2FSPN::WriteNodeclass(SP_DS_Nodeclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportSPN2FSPN::WritePlace(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportSPN2FSPN::WriteTransition(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool SP_ExportSPN2FSPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
	CHECK_POINTER(p_doc, return false);
	CHECK_POINTER(p_doc->GetGraph(), return false);
