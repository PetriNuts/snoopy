...
bool SP_ExportColFCPN2ColCPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColFCPN2ColCPN::Write(SP_MDI_Doc* p_doc,
...
bool SP_ExportColFCPN2ColCPN::WriteNetclass(SP_DS_Netclass* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColFCPN2ColCPN::WriteMetadataclass(SP_DS_Metadataclass* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
wxString  SP_ExportColFCPN2ColCPN::GetCrispValue(wxString& param, wxString& type)
{
	wxString crispValue;
...
SP_VectorDouble   SP_ExportColFCPN2ColCPN::GetFNConstants(wxString &val)
{
