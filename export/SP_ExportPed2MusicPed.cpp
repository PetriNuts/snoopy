...
bool
SP_ExportPed2MusicPed::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool
SP_ExportPed2MusicPed::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
  CHECK_POINTER(p_doc, return false);
  CHECK_POINTER(p_doc->GetGraph(), return false);
...
bool
SP_ExportPed2MusicPed::WriteNetclass(SP_DS_Netclass* p_pcVal,
				  wxXmlNode* p_pcRoot)
{
  ...
  l_pcElem->AddAttribute(wxT("name"), SP_DS_MUSICPN_CLASS);
