...
bool SP_ExportColCPN2ColFCPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColCPN2ColFCPN::Write(SP_MDI_Doc* p_doc,
...
bool SP_ExportColCPN2ColFCPN::WriteNetclass(SP_DS_Netclass* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColCPN2ColFCPN::WriteNodeclass(SP_DS_Nodeclass* p_pcVal,
	wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
	...
	if (SP_DS_CONTINUOUS_TRANS == l_sNodeclassName) /* || l_sNodeclassName == SP_DS_STOCHASTIC_TRANS) ||
...
bool SP_ExportColCPN2ColFCPN::WritePlace(SP_DS_Node* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColCPN2ColFCPN::WriteTransition(SP_DS_Node* p_pcVal,
	wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool SP_ExportColCPN2ColFCPN::WriteParameter(SP_DS_Node* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColCPN2ColFCPN::WriteEdgeclass(SP_DS_Edgeclass* p_pcVal,
	wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColCPN2ColFCPN::WriteEdge(SP_DS_Edge* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool
SP_ExportColCPN2ColFCPN::WriteEdgeGraphic(SP_GR_Edge* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool
SP_ExportColCPN2ColFCPN::WriteColourInformation(SP_Graphic* p_pcVal,
	wxXmlNode* p_pcNode)
{
	CHECK_POINTER(p_pcVal, return FALSE);
...
bool SP_ExportColCPN2ColFCPN::WriteMetadataclass(SP_DS_Metadataclass* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
