...
SP_ExportContODE2Octave::SP_ExportContODE2Octave() :
		SP_ExportPT()
{
...
bool SP_ExportContODE2Octave::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportContODE2Octave::DoWrite()
{
	...
	wxString l_sODE = wxT("% ode\n function xdot = f (x, t") + l_sConst + wxT(")\n");
	...
	l_sFunction << wxT("lsode_options ('integration method', 'bdf');\n");
	l_sFunction << wxT("lsode_options ()\n");
	l_sFunction << wxT("g = @(m0, t) f (m0, t") << l_sConst << wxT(");\n");
	l_sFunction << wxT("dx = lsode (g, m0, t);\n\n");
