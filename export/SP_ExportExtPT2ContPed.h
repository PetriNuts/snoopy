...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_EXPORTEXTPED2CONTPED_H__
#define __SP_EXPORTEXTPED2CONTPED_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportExtPT2ContPed: public SP_XmlWriter, public SP_ExportRoutine
{
private:
protected:
  SP_MDI_Doc* m_doc;
...
public:
  ...
  inline virtual wxString GetName()
    { return wxT("Export to Continuous Petri Net - mark Reset Edge red");}
  inline virtual wxString GetDescr()
    { return wxT("Export a Extended PT Net into Continuous Petri Net Format");}
...
#endif // __SP_EXPORTEXTPT2CONTPED_H__
