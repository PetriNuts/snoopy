...
#ifndef __SP_ExportColFSPN2ColFHPN_H__
#define __SP_ExportColFSPN2ColFHPN_H__

#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_XmlWriter.h"

class SP_ExportColFSPN2ColFHPN : public SP_ExportRoutine, private SP_XmlWriter
{
...
public:
	...
	{
		return wxT("Export to Colored Fuzzy Hybrid Petri Net");
	}

	inline virtual wxString GetDescr()
	{
		return wxT("Export a Colored Fuzzy Stochastic Petri Net into Colored Fuzzy Hybrid Petri Net Format");
	}
	...
	{
		return wxT("Colored Fuzzy Hybrid Petri Net Files");
	}
...
#endif // __SP_ExportColFSPN2ColFHPN_H__
