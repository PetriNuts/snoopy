...
#ifndef __SP_ExportColFHPN2ColFSPN_H__
#define __SP_ExportColFHPN2ColFSPN_H__

#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_XmlWriter.h"
#include "export/SpConvertElement.h"//Added by G.A

class SP_ExportColFHPN2ColFSPN : public SP_ExportRoutine, private SP_XmlWriter
{
...
public:
	...
	{
		return wxT("Export a Colored Fuzzy Hybrid Petri Net into Colored Fuzzy Stochastic Petri Net Format");
	}
...
#endif // __SP_ExportColFHPN2ColFSPN_H__
