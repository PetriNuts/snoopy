...
// $Date: 2020/11/9 $
//////////////////////////////////////////////////////////////////////
#ifndef __SP_ExportFHPN2ColFHPN_H__
#define __SP_ExportFHPN2ColFHPN_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportFHPN2ColFHPN : public SP_XmlWriter, public SP_ExportRoutine
{
private:
...
public:
	...
	{
		return wxT("Export an Fuzzy Hybrid Petri Net into Colored Fuzzy  Hybrid Petri Net Format");
	}
	...
	{
		return SP_DS_FUZZY_ColHPN_CLASS;
	}

};

#endif // __SP_ExportFHPN2ColFHPN_H__
