...
#ifndef __SP_ExportColHPN2ColEPN_H__
#define __SP_ExportColHPN2ColEPN_H__

#include "export/SP_ExportRoutine.h"
#include "sp_core/SP_XmlWriter.h"

class SP_ExportColHPN2ColEPN:  public SP_ExportRoutine, private SP_XmlWriter
{
 ...
 public:
  ...
  inline virtual wxString GetDescr()
    { return wxT("Export a Colored Hybrid Petri Net into Colored Extended Petri Net Format");}
...
#endif // __SP_ExportColHPN2ColEPN_H__
