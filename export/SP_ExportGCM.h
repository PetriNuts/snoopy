...
// $Version: 0.1 $
// $Date: 2011/03/04 $
// Short Description: export to GCM
//////////////////////////////////////////////////////////////////////
#ifndef __SP_EXPORTGCM__
#define __SP_EXPORTGCM__
...
class SP_ExportGCM: public SP_ExportPT
{
 protected:
  bool WritePlaces();
 ...
 public:
  SP_ExportGCM();
  virtual ~SP_ExportGCM();

  virtual bool AcceptsDoc(SP_MDI_Doc*);

  inline virtual wxString GetName()
    { return wxT("Export to GCM ");}
  inline virtual wxString GetDescr()
    { return wxT("Export a Petri Net in GCM Format");}
  virtual wxString GetExtension()
    { return wxT("gcm");}
  virtual wxString GetFileDescr()
    { return wxT("GCM Files");}
