...
bool SP_ExportColFHPN2ColHPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
...
bool SP_ExportColFHPN2ColHPN::Write(SP_MDI_Doc* p_doc,
...
bool SP_ExportColFHPN2ColHPN::WriteNetclass(SP_DS_Netclass* p_pcVal,
	wxXmlNode* p_pcRoot)
{
...
bool SP_ExportColFHPN2ColHPN::WriteMetadataclass(SP_DS_Metadataclass* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
wxString  SP_ExportColFHPN2ColHPN::GetCrispValue(wxString& param, wxString& type)
{
	wxString crispValue;
...
SP_VectorDouble   SP_ExportColFHPN2ColHPN::GetFNConstants(wxString &val)
{
