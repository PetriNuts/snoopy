...
* $Revision: 0.0 $
* $Date: 29.01.2019
* Short Description: Export FHPN===> FSPN
*/
//======================================================================================
#ifndef SP_EXPORTFHPN2FSPN_H_
#define SP_EXPORTFHPN2FSPN_H_

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"
#include "export/SpConvertElement.h"
class SP_ExportFHPN2FSPN : public SP_XmlWriter, public SP_ExportRoutine
{
private:
