...
bool SP_ExportFSPN2FHPN::Write(SP_MDI_Doc* p_doc, const wxString& p_fileName)
{
...
bool SP_ExportFSPN2FHPN::WriteNodeclass(SP_DS_Nodeclass* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportFSPN2FHPN::WritePlace(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot)
{
...
bool SP_ExportFSPN2FHPN::WriteTransition(SP_DS_Node* p_pcVal, wxXmlNode* p_pcRoot)
{
	CHECK_POINTER(p_pcVal, return FALSE);
	CHECK_POINTER(p_pcRoot, return FALSE);
...
bool SP_ExportFSPN2FHPN::AcceptsDoc(SP_MDI_Doc* p_doc)
{
	CHECK_POINTER(p_doc, return false);
	CHECK_POINTER(p_doc->GetGraph(), return false);
...
bool SP_ExportFSPN2FHPN::WriteMetadata(SP_DS_Metadata *p_pcVal, wxXmlNode *p_pcRoot)
{
