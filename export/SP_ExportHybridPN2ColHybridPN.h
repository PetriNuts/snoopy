...
// $Date: 2009/11/9 $
//////////////////////////////////////////////////////////////////////
#ifndef __SP_ExportHybridPN2ColHybridPN_H__
#define __SP_ExportHybridPN2ColHybridPN_H__

#include "sp_core/SP_XmlWriter.h"
#include "export/SP_ExportRoutine.h"

class SP_ExportHybridPN2ColHybridPN: public SP_XmlWriter, public SP_ExportRoutine
{
  private:
  ...
  public:
    ...
    inline virtual wxString GetDescr()
      { return wxT("Export an Hybrid Petri Net into Colored Hybrid Petri Net Format"); }

    virtual wxString GetExtension()
      { return wxT("colhpn"); }

    virtual wxString GetFileDescr()
      { return SP_DS_COLHPN_CLASS; }

};

#endif // __SP_ExportHybridPN2ColHybridPN__
