...
// Short Description:
//////////////////////////////////////////////////////////////////////
#ifndef __SP_WDG_STPARAMETERLIST_H__
#define __SP_WDG_STPARAMETERLIST_H__
...
class SP_WDG_StParameterList: public SP_WDG_DialogBase

{
  ...
  public:
    ...
    SP_WDG_StParameterList( const wxString& p_sPage = wxT("Page 1"), unsigned int p_nOrdering = std::numeric_limits<unsigned int>::max() );
    virtual ~SP_WDG_StParameterList();
...
#endif // __SP_WDG_STPARAMETERLIST_H__
