...
#endif
IMPLEMENT_CLASS(SP_DLG_DirSimulation, SP_DLG_BaseSimulation)
...
BEGIN_EVENT_TABLE(SP_DLG_DirSimulation, SP_DLG_BaseSimulation)

EVT_BUTTON(SP_ID_BUTTON_START_SIMULATION, SP_DLG_DirSimulation::OnStartAbortSimulation)

EVT_BUTTON(SP_ID_BUTTON_SIMULATION_PROPERTIES, SP_DLG_DirSimulation::OnSimulationProperties)

EVT_BUTTON(wxID_CANCEL, SP_DLG_DirSimulation::OnDlgCancel)

EVT_GRID_CELL_LEFT_DCLICK(SP_DLG_DirSimulation::OnColourClick)

EVT_GRID_LABEL_LEFT_DCLICK(SP_DLG_DirSimulation::OnLabelDClick)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_IN, SP_DLG_DirSimulation::OnPlotZoomH_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_OUT, SP_DLG_DirSimulation::OnPlotZoomH_Out)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_IN, SP_DLG_DirSimulation::OnPlotZoomV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_OUT, SP_DLG_DirSimulation::OnPlotZoomV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_IN, SP_DLG_DirSimulation::OnPlotZoomHV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_OUT, SP_DLG_DirSimulation::OnPlotZoomHV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_CENTRAL, SP_DLG_DirSimulation::OnPlotZoomCentral)

EVT_BUTTON(SP_ID_BUTTON_PLOT_SAVE_AREA, SP_DLG_DirSimulation::OnPlotSaveArea)

EVT_BUTTON(SP_ID_BUTTON_DIRECT_EXPORT_PROPERTIES, SP_DLG_DirSimulation::OnDirectExportProperties)
EVT_BUTTON(SP_ID_BUTTON_LOAD_DATA, SP_DLG_DirSimulation::OnLoadData)

EVT_BUTTON(SP_ID_PRINT, SP_DLG_DirSimulation::OnPrint)


EVT_TIMER(SP_ID_TIMER_UPDATE_DIALOG, SP_DLG_DirSimulation::OnTimer)

EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_PROPERTY_SIZER, SP_DLG_DirSimulation::OnCollapsePropertySizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_SETS_SIZER, SP_DLG_DirSimulation::OnCollapseSetsSizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_DIRECT_EXPORT_SIZER, SP_DLG_DirSimulation::OnCollapseDirectExportSizer)
EVT_BUTTON(SP_ID_BUTTON_SHOW_SELECTED_VIEWS, SP_DLG_DirSimulation::OnOpenSelectedGraphViews)
EVT_BUTTON(SP_ID_BUTTON_SHOW_ALL_VIEWS, SP_DLG_DirSimulation::OnOpenAllViewsSeparately)
EVT_BUTTON(SP_ID_BUTTON_ADD_NEW_VIEW, SP_DLG_DirSimulation::OnAddingNewModalView)
EVT_BUTTON(SP_ID_BUTTON_REMOVE_VIEWS, SP_DLG_DirSimulation::OnRemovingModalViews)

END_EVENT_TABLE()

SP_DLG_DirSimulation::SP_DLG_DirSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText, wxString p_sTitle, long p_nStyle) :
...

{
	...
	Bind(wxEVT_CLOSE_WINDOW, &SP_DLG_DirSimulation::OnCloseWindow, this);
}

void SP_DLG_DirSimulation::OnInitDialog(wxInitDialogEvent& event)
{
...
void SP_DLG_DirSimulation::SetMinimalLayout()
{
...
void SP_DLG_DirSimulation::SimulatorLogFunction(spsim::LogLevel  p_nLogLevel, const std::string& p_sLogMsg)
{
	switch (p_nLogLevel)
	{
...
void SP_DLG_DirSimulation::OnCollapsePropertySizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirSimulation::OnCollapseSetsSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirSimulation::OnCollapseDirectExportSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}


void SP_DLG_DirSimulation::OnOpenSelectedGraphViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirSimulation::RefreshCurrentExternalView(int p_nCurveIndex, wxString p_nColor, int p_nLineWidth, int p_nLineStyle)
{
...
void SP_DLG_DirSimulation::OnAddingNewModalView(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirSimulation::OnRemovingModalViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirSimulation::OnEditXAxis(wxWindow *p_pcExternalWindowDialog) {
	CHECK_POINTER(m_pcCurrentTablePlot, return);
...
void SP_DLG_DirSimulation::OnExportClicked(wxWindow *p_pcExternalWindowDialog, int p_nSelection) {
	if (p_nSelection == 0) {
		OnExportToCSV();
	}
}

bool SP_DLG_DirSimulation::CreateViewerDataFromRegex(SP_DS_Metadata* p_pcView)
{
			...
			if (l_RegExOutputType == wxT("Unfolded")) {
				for (unsigned int l_nRow = 0; l_nRow < m_ArrayUnPlaces.GetCount(); l_nRow++)
				{
					...
					if (match) {
						...
						{
							l_sCurveColor = SP_DLG_DirSimulation::GetColourString(l_nPosition);
						}
...
bool SP_DLG_DirSimulation::LoadViewerData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView, wxArrayString& p_asPlaces)
{
	wxString l_sName;
...
void SP_DLG_DirSimulation::LoadData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView)
{
...
void SP_DLG_DirSimulation::LoadData(bool p_bCreateNewTree)
{
...
void SP_DLG_DirSimulation::LoadSets()
{
...
void SP_DLG_DirSimulation::LoadParameters()
{
...
/*
void SP_DLG_DirSimulation::SaveSelectedCurves()
{
CHECK_POINTER(m_pcCurrentTablePlot, return);
...
void SP_DLG_DirSimulation::LoadSelectedCurves()
{
...
void SP_DLG_DirSimulation::OnColourClick(wxGridEvent& p_cEvent)
{
}

void SP_DLG_DirSimulation::OnLabelDClick(wxGridEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::AddNewMarkingSet(const wxString& p_sMarkingSetName, const int& p_nRow)
{
...
SP_DS_ColListAttribute* SP_DLG_DirSimulation::GetOneMakingAttribute()
{
	SP_DS_Nodeclass* l_pcNodeclass = m_pcGraph->GetNodeclass(SP_DS_CONTINUOUS_PLACE);
...
bool SP_DLG_DirSimulation::IsMarkingSetNameExist(const wxString& p_sName)
{
...
void SP_DLG_DirSimulation::OnModifyConstantSets(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnDlgCancel(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnCloseWindow(wxCloseEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnDirectExportProperties(wxCommandEvent& p_cEvent)
{
	bool l_bAlltraces = false;
	SP_DLG_StDirectExportProperties* l_pcDlg = new SP_DLG_StDirectExportProperties(SP_ST_SIM_EXPORT_CSV_EDIT_DLG_DIRECT, this, &m_sExportFilename, &m_nExportSpacer, &m_bCompressExact,&l_bAlltraces);

	l_pcDlg->ShowModal();

	l_pcDlg->Destroy();
}
void SP_DLG_DirSimulation::OnSimulationProperties(wxCommandEvent& p_cEvent)
{
...
wxColour SP_DLG_DirSimulation::GetNodeColour(SP_DS_Node* p_pcNode)
{
...
void SP_DLG_DirSimulation::OnPlotZoomH_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomH_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomHV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomHV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotZoomCentral(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::OnPlotSaveArea(wxCommandEvent& p_cEvent)
{
	/*if (m_pcCurrentTablePlotType == SP_TABLE_PLOT_TYPE_PLOT)
	{
...
wxBitmap SP_DLG_DirSimulation::GetEnlargeBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirSimulation::GetShrinkBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirSimulation::GetZoomInBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirSimulation::GetZoomOutBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxString SP_DLG_DirSimulation::GetSpacer(int p_nSpacer)
{
...
void SP_DLG_DirSimulation::OpenExportFile()
{
...
void SP_DLG_DirSimulation::CloseExportFile()
{
	if (m_pcCurrentTablePlot)
	{
...
void SP_DLG_DirSimulation::OnExportToCSV()
{
...
void SP_DLG_DirSimulation::LoadResults()
{
...
void SP_DLG_DirSimulation::OnLoadData(wxCommandEvent& p_cEvent)
{
...
SP_DLG_DirSimulation::~SP_DLG_DirSimulation()
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirSimulation::OnPrint(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::InitializeViews()
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
	long l_nPos = 0;
...
void SP_DLG_DirSimulation::OpenViewInSeparateWindow(SP_DS_Metadata* p_pcModelView)
{
	//check if a view with the same name is already opened
	for (auto l_itWindow : m_pcExternalWindows)
	{
	...
	SP_DLG_DShowAllModelView* l_pcShowModelViewsDlg = new SP_DLG_DShowAllModelView(this, p_pcModelView, m_pcGraph);
...
void SP_DLG_DirSimulation::OnOpenAllViewsSeparately(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirSimulation::RefreshExternalWindows()
{
	for (auto l_itWindow : m_pcExternalWindows)
	{
		if (l_itWindow != NULL)
...
SP_DS_Metadata* SP_DLG_DirSimulation::CreateNewView(const wxString& p_sName, bool p_bCloneCurrent)
{
	SP_DS_Metadataclass* l_pcMetadataclass;
...
bool SP_DLG_DirSimulation::IsViewNameExist(const wxString& p_sViewName)
{
...
void SP_DLG_DirSimulation::ChangeCurrentView(SP_DS_Metadata* p_pcView)
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirSimulation::ChangeViewTo(SP_DS_Metadata* p_pcView)
{
...
SP_DS_Metadata* SP_DLG_DirSimulation::FindView(const wxString& p_sViewName)
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
...
void SP_DLG_DirSimulation::SetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName, const wxString& p_sValue)
{
	CHECK_POINTER(p_pcView, return);
...
wxString SP_DLG_DirSimulation::GetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName)
{
...
wxString SP_DLG_DirSimulation::GetColourString(unsigned int p_nIndex)
{
...
void SP_DLG_DirSimulation::AddGuiOption2Simulator()
{
...
int SP_DLG_DirSimulation::LoadSimulatorProperties()
{
...
void SP_DLG_DirSimulation::SaveSimulatorProperties()
{
	SP_DS_Metadata* l_pcSimProp = *(m_pcGraph->GetMetadataclass(wxT("Simulation Properties"))->GetElements()->begin());
	SP_DS_Attribute* l_pcAttr = NULL;
...
void SP_DLG_DirSimulation::LoadNodeColours(const wxString& p_nNodeName, SP_VectorString& p_asColours)
{
	SP_DS_Nodeclass* l_pcNodeclass;
...
void SP_DLG_DirSimulation::UpdateChoices()
{
	m_choices.clear();
	SP_DS_Metadataclass* mc = m_pcGraph->GetMetadataclass(SP_DS_META_CONSTANT);
	if (mc)
...
void SP_DLG_DirSimulation::StartSimulation()
{
	DoStartSimulation();
}
