...

{
	...
	l_pcSizer->Add(new wxButton(this, SP_ID_BUTTON_ADD, wxT("Add variable") ), 1, wxLEFT | wxRIGHT | wxTOP, 5);	
	l_pcSizer->Add(new wxButton(this, SP_ID_BUTTON_DELETE, wxT("Delete variable") ), 1, wxLEFT | wxRIGHT | wxTOP, 5);
	l_pcSizer->Add(new wxButton(this, SP_ID_BUTTON_CHECK, wxT("Check variables") ), 1, wxLEFT | wxRIGHT | wxTOP, 5);
