...
IMPLEMENT_CLASS(SP_DLG_DPlacesSelection, wxDialog)
...
BEGIN_EVENT_TABLE(SP_DLG_DPlacesSelection, wxDialog)

EVT_BUTTON(wxID_OK, SP_DLG_DPlacesSelection::OnDlgOk)
EVT_BUTTON(wxID_CANCEL, SP_DLG_DPlacesSelection::OnDlgCancel)

EVT_BUTTON(SP_ID_BUTTON_LF2RT, SP_DLG_DPlacesSelection::OnLeftToRight)
EVT_BUTTON(SP_ID_BUTTON_RT2LF, SP_DLG_DPlacesSelection::OnRightToLeft)

EVT_BUTTON(SP_ID_BUTTON_LF2RTALL, SP_DLG_DPlacesSelection::OnLeftToRightAll)
EVT_BUTTON(SP_ID_BUTTON_RT2LFALL, SP_DLG_DPlacesSelection::OnRightToLeftAll)

EVT_TEXT(SP_ID_BUTTON_REGEX_COMPILE_SELECT, SP_DLG_DPlacesSelection::OnRegexSelection)
EVT_CHECKBOX(SP_ID_CHECKBOX_REGEX_INVERT_COMPILE, SP_DLG_DPlacesSelection::OnRegexSelection)

EVT_BUTTON(SP_ID_BUTTON_EDITAUXVAR, SP_DLG_DPlacesSelection::OnEditAuxVariable)

EVT_CHOICE(SP_ID_CHOICE_COLORPLACE_CHOICE, SP_DLG_DPlacesSelection::OnColPlaceSel)

EVT_RADIOBOX(SP_ID_PLACETRANSITIONRADIOBOX, SP_DLG_DPlacesSelection::OnChangedPlaceTransition)
EVT_RADIOBOX(SP_ID_OUTPUTTYPERADIOBOX, SP_DLG_DPlacesSelection::OnChangedOutType)

END_EVENT_TABLE()



SP_DLG_DPlacesSelection::SP_DLG_DPlacesSelection(SP_DS_Metadata* p_pcEditMetadata, wxWindow* p_pcParent,
...
void SP_DLG_DPlacesSelection::SetCommonLayout1()
{
	...
	{
		l_pcRowSizer = new wxBoxSizer(wxHORIZONTAL);
		wxString l_asOutputTypeChoices[] = { wxT("UnColored"), wxT("Colored"), wxT("Auxiliary variables") };
		...
		{
			//m_pcOutputTypeRadioBox->Show(0, false);
			m_pcOutputTypeRadioBox->Show(2, false);
			
		}
		
		/*else if (m_sNodeType == wxT("Place"))
		{
			m_pcOutputTypeRadioBox->Show(1, false);
			
		}*/
		if (m_sOutputType == wxT("UnColored"))
		{
...
void SP_DLG_DPlacesSelection::OnRegexSelection(wxCommandEvent& p_cEvent)
{
	NodesThroughRegEx();
}

void SP_DLG_DPlacesSelection::NodesThroughRegEx()
{
...
void SP_DLG_DPlacesSelection::LoadData()
{
	m_ArrayString.clear();
...
void SP_DLG_DPlacesSelection::OnDlgOk(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DPlacesSelection::OnDlgCancel(wxCommandEvent& p_cEvent)
{
	if (IsModal())
	{
...
void SP_DLG_DPlacesSelection::OnLeftToRight(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DPlacesSelection::OnLeftToRightAll(wxCommandEvent& p_cEvent)
{
	wxArrayInt l_Selections;
	wxArrayString l_ArrayTemp;
	for (unsigned int i = 0; i < m_pListBoxOut->GetCount(); i++) {
...
void SP_DLG_DPlacesSelection::OnRightToLeft(wxCommandEvent& p_cEvent)
{
	wxArrayInt l_Selections;
	wxString l_SelectionItem;
...
void SP_DLG_DPlacesSelection::OnRightToLeftAll(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DPlacesSelection::OnEditAuxVariable(wxCommandEvent& p_cEvent)
{
}

void SP_DLG_DPlacesSelection::GetSelResults()
{
...
void SP_DLG_DPlacesSelection::LoadNodeColours(const wxString& p_nNodeName, SP_VectorString& p_asColours)
{
...
void SP_DLG_DPlacesSelection::SaveMetaData()
{
	...
	for (unsigned int i = 0; i < m_vmSelectedNodes.size(); i++)
	{
		...
		{
			l_sCurveColor << SP_DLG_DirColorSimulation::GetColourString(i);
		}
...
void SP_DLG_DPlacesSelection::OnChangedPlaceTransition(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DPlacesSelection::OnChangedOutType(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DPlacesSelection::Initialize()
{
...
void SP_DLG_DPlacesSelection::InitilizeFromMetaData()
{
	if (m_sNodeType == wxT("Place"))
	{
		m_pcPlaceTransitionRadioBox->SetSelection(0);
...
void SP_DLG_DPlacesSelection::AddtoCurLBInStrings(wxString p_sName)
{
...
void SP_DLG_DPlacesSelection::RemovefromCurLBInStrings(wxString p_sName)
{
