...
#ifndef __SP_DLG_DPlacesSelection_H__
#define __SP_DLG_DPlacesSelection_H__
...
typedef enum
{
	SP_COLPN_OUTPUTTYPE_DUNFOLDED,   //UnColored
	SP_COLPN_OUTPUTTYPE_DCOLORED,    //Colored
	SP_COLPN_OUTPUTTYPE_DAUXILIARY   //Auxiliary variables

} SP_DColPNOutputType;

struct SP_ColPN_Position_DOutputType
{
	long m_nPosition;
...
class SP_DLG_DPlacesSelection : public wxDialog
{
...
protected:
	...
	vector<SP_ColPN_Position_DOutputType> m_vmSelectedNodes;
...
public:
	...
	SP_DLG_DPlacesSelection(SP_DS_Metadata* p_pcEditMetadata, wxWindow* p_pcParent,
		const wxString& p_sTitle = wxT("Edit"),
		long p_nStyle = wxDEFAULT_DIALOG_STYLE);

public:
	vector< SP_ColPN_Position_DOutputType > GetSelectedNodes()
	{
...
#endif // __SP_DLG_DPlacesSelection_H__
