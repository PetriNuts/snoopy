#ifndef _SP_DS_FSPNSIMTHREAD_H_
#define _SP_DS_FSPNSIMTHREAD_H_
...
class SP_DS_FspnSimulThread : public wxThread
{
public:
	SP_DS_FspnSimulThread(wxWindow* p_pcParent, spsim::Simulator* p_pcSimulator, double alpha, std::vector<double> m_currentSample, bool m_bIsAbort = false);
	~SP_DS_FspnSimulThread();
protected:
	void * Entry();
public:
