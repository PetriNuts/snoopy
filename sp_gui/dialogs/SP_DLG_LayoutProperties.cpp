...
m_pcDoc(p_pcDoc)
{
	...
	l_pcLayoutSizer->Add(new wxStaticText(this, -1, wxT("Layout:")), 0, wxRIGHT | wxALIGN_CENTER_VERTICAL, 5);
	...
	l_pcNodeSizer->Add(new wxStaticText(this, -1, wxT("Nodeseperation:")), 0, wxRIGHT | wxALIGN_CENTER_VERTICAL, 5);
