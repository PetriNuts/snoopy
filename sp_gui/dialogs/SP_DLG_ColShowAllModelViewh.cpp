...
IMPLEMENT_CLASS(SP_DLG_ColShowAllModelView, wxFrame)
...
BEGIN_EVENT_TABLE(SP_DLG_ColShowAllModelView, wxFrame)
END_EVENT_TABLE()


SP_DLG_ColShowAllModelView::SP_DLG_ColShowAllModelView(SP_DLG_DirColorSimulation* p_pcWnd, SP_DS_Metadata* p_pcModelView, SP_DS_Graph* p_pcGraph) :
	...
	m_bIsDisconnected(false), m_bIsShown(true)
{
	...
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnClose, this, wxID_CANCEL);
	Bind(wxEVT_CLOSE_WINDOW, &SP_DLG_ColShowAllModelView::OnWindowClose, this);

	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnRefresh, this, SP_ID_BUTTON_REFRESH);

	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnDisconnect, this, SP_ID_BUTTON_DISCONNECT);

	Bind(wxEVT_LISTBOX_DCLICK, &SP_DLG_ColShowAllModelView::OnItemDoubleClick, this, SP_ID_CHECKLISTBOX_PLACE_CHOICE);
	Bind(wxEVT_CHECKLISTBOX, &SP_DLG_ColShowAllModelView::OnPlaceCheckUncheck, this, SP_ID_CHECKLISTBOX_PLACE_CHOICE);
	Bind(wxEVT_CHECKBOX, &SP_DLG_ColShowAllModelView::OnSelectClearAllItems, this, SP_ID_BUTTON_SELECT_CLEAR_ALL_ITEMS);
	Bind(wxEVT_CHOICE, &SP_DLG_ColShowAllModelView::OnChangeResultViewer, this, SP_ID_CHOICE_RESULT_VIEWER_TYPE);
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnEditViewerProperties, this, SP_ID_BUTTON_EDIT_VIEWER_PROPERTIES);
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnExportClick, this, SP_ID_BUTTON_EXPORT);
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnChangeXAxis, this, SP_ID_CHANGE_X_AXIS);
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnEditNodeList, this, SP_ID_BUTTON_EDIT_NODE_LIST);
	Bind(wxEVT_BUTTON, &SP_DLG_ColShowAllModelView::OnShowHideNodeList, this, SP_ID_BUTTON_SHOW_HIDE_NODE_LIST);

	Bind(wxEVT_ACTIVATE, &SP_DLG_ColShowAllModelView::OnWindowActivate, this);
}




SP_DLG_ColShowAllModelView::~SP_DLG_ColShowAllModelView()
{
...
void SP_DLG_ColShowAllModelView::OnItemDoubleClick(wxCommandEvent& p_cEvent) {
...
void SP_DLG_ColShowAllModelView::OnPlaceCheckUncheck(wxCommandEvent& p_cEvent) {
	//get item index
...
void SP_DLG_ColShowAllModelView::OnSelectClearAllItems(wxCommandEvent& p_cEvent)
{
	SP_DS_Attribute* l_pcAttribute = m_pcModelView->GetAttribute(wxT("CurveInfo"));
...
void SP_DLG_ColShowAllModelView::OnEditViewerProperties(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_ColShowAllModelView::OnChangeResultViewer(wxCommandEvent& event)
{
...
void SP_DLG_ColShowAllModelView::OnExportClick(wxCommandEvent& event)
{
...
void SP_DLG_ColShowAllModelView::OnChangeXAxis(wxCommandEvent& event)
{
	m_pcParentWnd->OnEditXAxis(this);
	RefreshWindow();
}

void SP_DLG_ColShowAllModelView::OnEditNodeList(wxCommandEvent& event)
{
		...
		|| l_TempClassName == SP_DS_COLHPN_CLASS)
	{
		...
		SP_DLG_DColPlacesSelection* l_pcDlg = new SP_DLG_DColPlacesSelection(m_pcParentWnd, m_pcModelView, this);
...
void SP_DLG_ColShowAllModelView::OnShowHideNodeList(wxCommandEvent& event)
{
...
bool SP_DLG_ColShowAllModelView::LoadView(SP_DS_ResultViewer* p_pcResultViewer, SP_DS_Metadata* p_pcModelView)
...
void SP_DLG_ColShowAllModelView::LoadCurveSetting(SP_DS_ResultViewer* p_pcViewer, SP_DS_ColListAttribute* p_pcCurveInfoList, const unsigned int& p_nRow)
{
	//Get the item ID
...
void SP_DLG_ColShowAllModelView::OnRefresh(wxCommandEvent& event)
{
	RefreshWindow();
}

void SP_DLG_ColShowAllModelView::CreateResultViewer()
{
	SP_DS_Attribute* l_pcAttribute = m_pcModelView->GetAttribute(wxT("ViewerType"));
...
void SP_DLG_ColShowAllModelView::OnClose(wxCommandEvent& event)
{
	DoClose();
	Close(true);
}

void SP_DLG_ColShowAllModelView::OnWindowClose(wxCloseEvent& event)
{
	DoClose();
	event.Skip();
}

void SP_DLG_ColShowAllModelView::DoClose()
{
...
void SP_DLG_ColShowAllModelView::RemoveExternalWindowsPointer()
{
...
void SP_DLG_ColShowAllModelView::RefreshWindow()
{
...
void SP_DLG_ColShowAllModelView::RefreshCurrentWindow(int p_nCurveIndex, wxString p_nColor, int p_nLineWidth, int p_nLineStyle)
{
	if (m_bIsDisconnected)
	{
		return; //no need to refresh
...
void SP_DLG_ColShowAllModelView::OnWindowActivate(wxActivateEvent& event)
{
	if (event.GetActive())
	{
		if (m_pcParentWnd != NULL )
...
wxString SP_DLG_ColShowAllModelView::GetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName)
{
...
void SP_DLG_ColShowAllModelView::OnDisconnect(wxCommandEvent &event)
{
	if (!m_bIsDisconnected)
	{
