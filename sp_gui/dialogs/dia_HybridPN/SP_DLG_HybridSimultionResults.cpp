...
EVT_COMBOBOX( SP_ID_COMBOBOX_MARKING_SETS, SP_DLG_HybridSimulationResults::OnMarkingSetChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_FUNCTION_SETS, SP_DLG_HybridSimulationResults::OnFunctionSetChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_STOCHASTIC_RATE_SETS, SP_DLG_HybridSimulationResults::OnStochasticRateChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_IMMEDIATE_SETS, SP_DLG_HybridSimulationResults::OnImmediateSetChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_DELAY_SETS, SP_DLG_HybridSimulationResults::OnDelaySetChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_SCHEDULED_SETS, SP_DLG_HybridSimulationResults::OnScheduledSetChanged )

//EVT_COMBOBOX( SP_ID_COMBOBOX_PARAMETER_SETS, SP_DLG_HybridSimulationResults::OnParameterSetChanged )
//EVT_COMBOBOX( SP_ID_COMBOBOX_DELAY_SETS, SP_DLG_HybridSimulationResults::OnParameterSetChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_SOLVER, SP_DLG_HybridSimulationResults::OnSolverChanged )
EVT_COMBOBOX( SP_ID_COMBOBOX_TIME_SYNC, SP_DLG_HybridSimulationResults::OnTimeSyncTypeChanged )
