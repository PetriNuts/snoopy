...
IMPLEMENT_CLASS(SP_DLG_DuplicateNodes, wxDialog)
...
BEGIN_EVENT_TABLE(SP_DLG_DuplicateNodes, wxDialog)
	EVT_BUTTON(wxID_OK, SP_DLG_DuplicateNodes::OnDlgOk)
...
SP_DLG_DuplicateNodes::SP_DLG_DuplicateNodes(SP_DS_Graph *p_graph, unsigned int p_netNumber, SP_ListGraphic* p_graphics, wxWindow *p_parent, const wxString& p_title) :
...
SP_DLG_DuplicateNodes::~SP_DLG_DuplicateNodes()
{
}

void SP_DLG_DuplicateNodes::Clear()
{
...
void SP_DLG_DuplicateNodes::OnDlgOk(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DuplicateNodes::OnDlgApply( wxCommandEvent& p_cEvent )
{
	if (Validate() && TransferDataFromWindow() )
	{
		DoApply();
...
void SP_DLG_DuplicateNodes::DoApply()
{
	m_graphics->clear();
...
void SP_DLG_DuplicateNodes::OnDlgClose(wxCommandEvent& p_cEvent)
{
	if (Validate() && TransferDataFromWindow() )
	{
		Clear();
...
void SP_DLG_DuplicateNodes::OnRadio( wxCommandEvent& p_cEvent )
{
	LoadData( m_choice->GetStringSelection(), m_number->GetValue() );

}

void SP_DLG_DuplicateNodes::OnSpin(wxSpinEvent &p_cEvent)
{
	LoadData( m_choice->GetStringSelection(), m_number->GetValue() );
