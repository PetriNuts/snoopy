...
*/
//////////////////////////////////////////////////////////////////////
#ifndef __SP_DLG_DIRCOLSTSIMULATION__
#define __SP_DLG_DIRCOLSTSIMULATION__
...
{
	SP_SIM_NO_EXPORTc,
	SP_SIM_DIRECT_EXPORTc,
	SP_SIM_DIRECT_SINGLE_EXPORTc,
	SP_SIM_DIRECT_SINGLE_EXACT_EXPORTc,
	SP_SIM_EXPORT_SNOOPY_FILEc
} SP_ExportTypec;
...
class SP_DLG_DirColStSimulation : public SP_DLG_BaseSimulation
{
protected:
	// Current Graph
...
protected:
	...
	DECLARE_CLASS(SP_DLG_DirColStSimulation)
public:
	SP_DLG_DirColStSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText = wxT(""), wxString p_sTitle = wxT("Simulation controls"), long p_nStyle = wxDEFAULT_DIALOG_STYLE);

	virtual ~SP_DLG_DirColStSimulation();
	...
	virtual SP_ExportTypec GetExportType()
	{
		return m_ExportType;
	}
