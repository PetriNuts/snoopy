...
#include "sp_gui/dialogs/SP_DLG_DirColStSimulation.h"
...
#endif
IMPLEMENT_CLASS(SP_DLG_DirColStSimulation, SP_DLG_BaseSimulation)
...
BEGIN_EVENT_TABLE(SP_DLG_DirColStSimulation, SP_DLG_BaseSimulation)

EVT_BUTTON(SP_ID_BUTTON_START_SIMULATION, SP_DLG_DirColStSimulation::OnStartAbortSimulation)

EVT_BUTTON(SP_ID_BUTTON_SIMULATION_PROPERTIES, SP_DLG_DirColStSimulation::OnSimulationProperties)

EVT_BUTTON(wxID_CANCEL, SP_DLG_DirColStSimulation::OnDlgCancel)

EVT_GRID_CELL_LEFT_DCLICK(SP_DLG_DirColStSimulation::OnColourClick)

EVT_GRID_LABEL_LEFT_DCLICK(SP_DLG_DirColStSimulation::OnLabelDClick)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_IN, SP_DLG_DirColStSimulation::OnPlotZoomH_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_OUT, SP_DLG_DirColStSimulation::OnPlotZoomH_Out)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_IN, SP_DLG_DirColStSimulation::OnPlotZoomV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_OUT, SP_DLG_DirColStSimulation::OnPlotZoomV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_IN, SP_DLG_DirColStSimulation::OnPlotZoomHV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_OUT, SP_DLG_DirColStSimulation::OnPlotZoomHV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_CENTRAL, SP_DLG_DirColStSimulation::OnPlotZoomCentral)

EVT_BUTTON(SP_ID_BUTTON_PLOT_SAVE_AREA, SP_DLG_DirColStSimulation::OnPlotSaveArea)

EVT_BUTTON(SP_ID_BUTTON_DIRECT_EXPORT_PROPERTIES, SP_DLG_DirColStSimulation::OnDirectExportProperties)
EVT_BUTTON(SP_ID_BUTTON_LOAD_DATA, SP_DLG_DirColStSimulation::OnLoadData)

EVT_BUTTON(SP_ID_PRINT, SP_DLG_DirColStSimulation::OnPrint)


EVT_TIMER(SP_ID_TIMER_UPDATE_DIALOG, SP_DLG_DirColStSimulation::OnTimer)

EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_PROPERTY_SIZER, SP_DLG_DirColStSimulation::OnCollapsePropertySizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_SETS_SIZER, SP_DLG_DirColStSimulation::OnCollapseSetsSizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_DIRECT_EXPORT_SIZER, SP_DLG_DirColStSimulation::OnCollapseDirectExportSizer)
EVT_BUTTON(SP_ID_BUTTON_SHOW_SELECTED_VIEWS, SP_DLG_DirColStSimulation::OnOpenSelectedGraphViews)
EVT_BUTTON(SP_ID_BUTTON_SHOW_ALL_VIEWS, SP_DLG_DirColStSimulation::OnOpenAllViewsSeparately)
EVT_BUTTON(SP_ID_BUTTON_ADD_NEW_VIEW, SP_DLG_DirColStSimulation::OnAddingNewModalView)
EVT_BUTTON(SP_ID_BUTTON_REMOVE_VIEWS, SP_DLG_DirColStSimulation::OnRemovingModalViews)

END_EVENT_TABLE()

SP_DLG_DirColStSimulation::SP_DLG_DirColStSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText, wxString p_sTitle, long p_nStyle) :
...

{
	...
	Bind(wxEVT_CLOSE_WINDOW, &SP_DLG_DirColStSimulation::OnCloseWindow, this);
}

void SP_DLG_DirColStSimulation::OnInitDialog(wxInitDialogEvent& event)
{
...
void SP_DLG_DirColStSimulation::SetMinimalLayout()
{
...
void SP_DLG_DirColStSimulation::OnCollapsePropertySizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirColStSimulation::OnCollapseSetsSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirColStSimulation::OnCollapseDirectExportSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}


void SP_DLG_DirColStSimulation::OnOpenSelectedGraphViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColStSimulation::RefreshCurrentExternalView(int p_nCurveIndex, wxString p_nColor, int p_nLineWidth, int p_nLineStyle)
{
...
void SP_DLG_DirColStSimulation::OnAddingNewModalView(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColStSimulation::OnRemovingModalViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColStSimulation::OnEditXAxis(wxWindow *p_pcExternalWindowDialog) {
	CHECK_POINTER(m_pcCurrentTablePlot, return);
...
void SP_DLG_DirColStSimulation::OnExportClicked(wxWindow *p_pcExternalWindowDialog, int p_nSelection) {
	if (p_nSelection == 0) {
		OnExportToCSV();
	}
}

bool SP_DLG_DirColStSimulation::CreateViewerDataFromRegex(SP_DS_Metadata* p_pcView)
{
...
bool SP_DLG_DirColStSimulation::LoadViewerData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView, wxArrayString& p_asPlaces)
{
	wxString l_sName;
...
void SP_DLG_DirColStSimulation::LoadData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView)
{
...
void SP_DLG_DirColStSimulation::LoadData(bool p_bCreateNewTree)
{
...
void SP_DLG_DirColStSimulation::LoadSets()
{
...
void SP_DLG_DirColStSimulation::LoadParameters()
{
...
void SP_DLG_DirColStSimulation::OnColourClick(wxGridEvent& p_cEvent)
{
}

void SP_DLG_DirColStSimulation::OnLabelDClick(wxGridEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::AddNewMarkingSet(const wxString& p_sMarkingSetName, const int& p_nRow)
{
...
SP_DS_ColListAttribute* SP_DLG_DirColStSimulation::GetOneMakingAttribute()
{
	SP_DS_Nodeclass* l_pcNodeclass = m_pcGraph->GetNodeclass(SP_DS_CONTINUOUS_PLACE);
...
bool SP_DLG_DirColStSimulation::IsMarkingSetNameExist(const wxString& p_sName)
{
...
void SP_DLG_DirColStSimulation::OnModifyConstantSets(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnDlgCancel(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnCloseWindow(wxCloseEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnSimulationProperties(wxCommandEvent& p_cEvent)
{
...
wxColour SP_DLG_DirColStSimulation::GetNodeColour(SP_DS_Node* p_pcNode)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomH_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomH_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomHV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomHV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotZoomCentral(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::OnPlotSaveArea(wxCommandEvent& p_cEvent)
{
	/*if (m_pcCurrentTablePlotType == SP_TABLE_PLOT_TYPE_PLOT)
	{
...
wxBitmap SP_DLG_DirColStSimulation::GetEnlargeBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColStSimulation::GetShrinkBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColStSimulation::GetZoomInBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColStSimulation::GetZoomOutBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxString SP_DLG_DirColStSimulation::GetSpacer(int p_nSpacer)
{
...
void SP_DLG_DirColStSimulation::OpenExportFile()
{
...
void SP_DLG_DirColStSimulation::CloseExportFile()
{
	if (m_pcCurrentTablePlot)
	{
...
void SP_DLG_DirColStSimulation::OnExportToCSV()
{
...
void SP_DLG_DirColStSimulation::LoadResults()
{
...
void SP_DLG_DirColStSimulation::OnLoadData(wxCommandEvent& p_cEvent)
{
...
SP_DLG_DirColStSimulation::~SP_DLG_DirColStSimulation()
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirColStSimulation::OnPrint(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::InitializeViews()
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
	long l_nPos = 0;
...
void SP_DLG_DirColStSimulation::OpenViewInSeparateWindow(SP_DS_Metadata* p_pcModelView)
{
	//check if a view with the same name is already opened
	for (auto l_itWindow : m_pcExternalWindows)
	{
...
void SP_DLG_DirColStSimulation::OnOpenAllViewsSeparately(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColStSimulation::RefreshExternalWindows()
{
	for (auto l_itWindow : m_pcExternalWindows)
	{
		if (l_itWindow != NULL)
...
SP_DS_Metadata* SP_DLG_DirColStSimulation::CreateNewView(const wxString& p_sName, bool p_bCloneCurrent)
{
	SP_DS_Metadataclass* l_pcMetadataclass;
...
bool SP_DLG_DirColStSimulation::IsViewNameExist(const wxString& p_sViewName)
{
...
void SP_DLG_DirColStSimulation::ChangeCurrentView(SP_DS_Metadata* p_pcView)
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirColStSimulation::ChangeViewTo(SP_DS_Metadata* p_pcView)
{
...
SP_DS_Metadata* SP_DLG_DirColStSimulation::FindView(const wxString& p_sViewName)
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
...
void SP_DLG_DirColStSimulation::SetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName, const wxString& p_sValue)
{
	CHECK_POINTER(p_pcView, return);
...
wxString SP_DLG_DirColStSimulation::GetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName)
{
...
wxString SP_DLG_DirColStSimulation::GetColourString(unsigned int p_nIndex)
{
...
void SP_DLG_DirColStSimulation::SaveSimulatorProperties()
{
	SP_DS_Metadata* l_pcSimProp = *(m_pcGraph->GetMetadataclass(wxT("Simulation Properties"))->GetElements()->begin());
	SP_DS_Attribute* l_pcAttr = NULL;
...
void SP_DLG_DirColStSimulation::LoadNodeColours(const wxString& p_nNodeName, SP_VectorString& p_asColours)
{
	SP_DS_Nodeclass* l_pcNodeclass;
...
void SP_DLG_DirColStSimulation::UpdateChoices()
{
	m_choices.clear();
	SP_DS_Metadataclass* mc = m_pcGraph->GetMetadataclass(SP_DS_META_CONSTANT);
	if (mc)
...
void SP_DLG_DirColStSimulation::StartSimulation()
{
	DoStartSimulation();
}
