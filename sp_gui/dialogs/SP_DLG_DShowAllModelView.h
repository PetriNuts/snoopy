...
*/ //======================================================================================
#ifndef SP_DLG_DSHOWALLMODELVIEW_H_
#define SP_DLG_DSHOWALLMODELVIEW_H_
...
class SP_DLG_DShowAllModelView : public wxFrame, public SP_Error
{
private:
	DECLARE_EVENT_TABLE();
	DECLARE_CLASS(SP_DLG_DShowAllModelView)
	...
	SP_DLG_DirSimulation* m_pcParentWnd;
...
public:
	...
	SP_DLG_DShowAllModelView(SP_DLG_DirSimulation* p_pcWnd, SP_DS_Metadata* p_pcModelView, SP_DS_Graph* p_pcGraph);
	virtual ~SP_DLG_DShowAllModelView();
