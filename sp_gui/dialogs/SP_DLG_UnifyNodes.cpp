...
IMPLEMENT_CLASS(SP_DLG_UnifyNodes, SP_DLG_DivideNodes)

BEGIN_EVENT_TABLE(SP_DLG_UnifyNodes, SP_DLG_DivideNodes)
END_EVENT_TABLE()

SP_DLG_UnifyNodes::SP_DLG_UnifyNodes(SP_DS_Graph *p_graph, unsigned int p_netNumber, SP_ListGraphic* p_graphics, wxWindow *p_parent, const wxString& p_title) :
		SP_DLG_DivideNodes(p_graph, p_netNumber, p_graphics, p_parent, p_title)
{
	if (m_choice)
	{
...
SP_DLG_UnifyNodes::~SP_DLG_UnifyNodes()
{
}

void SP_DLG_UnifyNodes::LoadData(const wxString& p_sNodeClassName, int p_nNrArcs)
{
	//Load data
	Clear();
