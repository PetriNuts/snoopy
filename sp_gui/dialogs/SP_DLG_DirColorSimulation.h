...
#ifndef __SP_DLG_DirColorSIMULATION__
#define __SP_DLG_DirColorSIMULATION__
...
#include "spsim/colorsimulator.h"
...
{
	SP_SIM_NO_DEXPORT,
	SP_SIM_DIRECT_DEXPORT,
	SP_SIM_DIRECT_DSINGLE_EXPORT,
	SP_SIM_DIRECT_DSINGLE_EXACT_EXPORT,
	SP_SIM_EXPORT_DSNOOPY_FILE
} SP_ExportTypeDC;

class SP_DS_Simulation;
class SP_DS_ResultViewer;
class SP_DLG_ColShowAllModelView;

class SP_DLG_DirColorSimulation : public SP_DLG_BaseSimulation
{
protected:
	// Current Graph
	...
	//New Simulator
	spsim::ColorSimulator* m_pcMainSimulator;
	
	SP_VectorStdString m_asColPlaceNames;
...
protected:
	...
	std::list<SP_DLG_ColShowAllModelView*> m_pcExternalWindows;

public:
	wxArrayString m_ArrayUncolPlaces, m_ArrayUnTranstions;
...
protected:
	...
	*/
//	SP_VectorString m_asColPlaceNames;
...
public:
	...
	void RemoveExternalWindow(SP_DLG_ColShowAllModelView* p_pcWindow)
	{
...
protected:
	...
	*/
	...
	virtual spsim::ColorSimulator* CreateSimulator(const int& p_nSimulatorType) = 0;
...
protected:
	...
	DECLARE_CLASS(SP_DLG_DirColorSimulation)
public:
	SP_DLG_DirColorSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText = wxT(""), wxString p_sTitle = wxT("Simulation controls"), long p_nStyle = wxDEFAULT_DIALOG_STYLE);

	virtual ~SP_DLG_DirColorSimulation();
	...
	/*virtual SP_ExportTypeDC GetExportType()
	{
		return m_ExportType;
	}*/
...
#endif // __SP_DLG_DirColorSIMULATION__
