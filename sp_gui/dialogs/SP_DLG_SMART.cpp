...
SP_DLG_SMART::CreateNotebookPages() {
	...
	m_pcPageSizer->Add(0, 10, 0);
		...
		elemsizer->Add(new wxStaticText(m_pcNotebookPage, -1, wxT("net - name: ") + ExportConfig->GetConfigurationElement(wxT("netname"))->value), 0, 
										wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
	...
	m_pcNotebook->AddPage( m_pcNotebookPage, wxT("partition"));
		...
		elemsizer->Add(CheckBox_Part_1, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
		...
		elemsizer->Add(CheckBox_Part_2, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
		//auto partition
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(CheckBox_Part_3, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		elemsizer->Add(new wxStaticText(m_pcNotebookPage,-1,wxT("   Coarse depth:")), 0, wxALIGN_CENTER_VERTICAL , 5);
		...
		elemsizer->Add(new wxStaticText(m_pcNotebookPage,-1,wxT("  min number of places:")), 0, wxALIGN_CENTER_VERTICAL , 5);
		...
		elemsizer->Add(CheckBox_Part_4, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
		//listboxes
		//wxSize* s= new wxSize();
		s.SetHeight(170);
		...
		//first box
			...
			elemsizer->Add(ListBoxallpart1, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
		//Buttons	
			helemsizer = new wxBoxSizer(wxVERTICAL);
			helemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_DELETE_PARTITION, wxT( "delete Partition" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
			helemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_NEW_PARTITION, wxT( "new Partition" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
			elemsizer->Add(helemsizer, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		//second box
			ListBoxallpart2 = new wxListBox(m_pcNotebookPage, -1,wxDefaultPosition,s);
			elemsizer->Add(ListBoxallpart2, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
		//buttons
			helemsizer = new wxBoxSizer(wxVERTICAL);
			helemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_ELEMENTTO_PARTITION, wxT( "<<" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
			helemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_ELEMENTFROM_PARTITION, wxT( ">>" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
			elemsizer->Add(helemsizer, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		//third box
			ListBoxallpart3 = new wxListBox(m_pcNotebookPage, -1,wxDefaultPosition,s);
			elemsizer->Add(ListBoxallpart3, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 0);
			UpdateListboxes();
		//load /save buttons partition
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		elemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_PARTITION_LOAD, wxT( "Load Partition" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		elemsizer->Add( new wxButton( m_pcNotebookPage, SP_ID_BUTTON_PARTITION_SAVE, wxT( "Save Partition" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
		m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
	...
	m_pcNotebook->AddPage( m_pcNotebookPage, wxT("optimisation - options"));
		...
		ExportConfig->SetConfigurationElement(wxT("GarbageCollection"),checkbox_GarbageCollection->GetValue(),combobox_GarbageCollection->GetStringSelection());
		elemsizer->Add(combobox_GarbageCollection, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		...
		elemsizer->Add(combobox_IgnoreWeightClasses, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		...
		ExportConfig->SetConfigurationElement(wxT("StateStorage"),checkbox_StateStorage->GetValue(),combobox_StateStorage->GetStringSelection());
		elemsizer->Add(combobox_StateStorage, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//MarkovStorage
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("MarkovStorage"),checkbox_MarkovStorage->GetValue(),combobox_MarkovStorage->GetStringSelection());
		elemsizer->Add(combobox_MarkovStorage, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//RealFormat
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("RealFormat"),checkbox_RealFormat->GetValue(),combobox_RealFormat->GetStringSelection());	
		elemsizer->Add(combobox_RealFormat, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		...
		ExportConfig->SetConfigurationElement(wxT("BFSTrace"),checkbox_BFSTrace->GetValue(),combobox_BFSTrace->GetStringSelection());
		elemsizer->Add(combobox_BFSTrace, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		...
		ExportConfig->SetConfigurationElement(wxT("EmbedWithElim"),checkbox_EmbedWithElim->GetValue(),combobox_EmbedWithElim->GetStringSelection());
		elemsizer->Add(combobox_EmbedWithElim, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//EUStrategy
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("EUStrategy"),checkbox_EUStrategy->GetValue(),combobox_EUStrategy->GetStringSelection());
		elemsizer->Add(combobox_EUStrategy, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//GarbageUnit
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("GarbageUnit"),checkbox_GarbageUnit->GetValue(),combobox_GarbageUnit->GetStringSelection());
		elemsizer->Add(combobox_GarbageUnit, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//GarbageSize
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_GarbageSize, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//IgnoreWeightClasses
		//MatrixByRows
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("MatrixByRows"),checkbox_MatrixByRows->GetValue(),combobox_MatrixByRows->GetStringSelection());
		elemsizer->Add(combobox_MatrixByRows, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//MaxConvergeIters
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_MaxConvergeIters, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//MaxNumericalIters
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_MaxNumericalIters, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//MaxPrintedItems
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_MaxPrintedItems, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		...
		ExportConfig->SetConfigurationElement(wxT("init_option"),checkbox_init_option->GetValue(),combobox_init_option->GetStringSelection());
		elemsizer->Add(combobox_init_option, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//numstates
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("num_states"),checkbox_num_states->GetValue(),combobox_num_states->GetStringSelection());
		elemsizer->Add(combobox_num_states, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer, 0, wxEXPAND);
		//num_arcs
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("num_arcs"),checkbox_num_arcs->GetValue(),combobox_num_arcs->GetStringSelection());
		elemsizer->Add(combobox_num_arcs, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer, 0, wxEXPAND);
		//Report
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("Report"),checkbox_Report->GetValue(),combobox_Report->GetStringSelection());
		elemsizer->Add(combobox_Report, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//Verbose
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("Verbose"),checkbox_Verbose->GetValue(),combobox_Verbose->GetStringSelection());
		elemsizer->Add(combobox_Verbose, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//InfinityString
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_InfinityString, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//ParameterWarnings
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("ParameterWarnings"),checkbox_ParameterWarnings->GetValue(),combobox_ParameterWarnings->GetStringSelection());
		elemsizer->Add(combobox_ParameterWarnings, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//WriteDotOutput
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("WriteDotOutput"),checkbox_WriteDotOutput->GetValue(),combobox_WriteDotOutput->GetStringSelection());
		elemsizer->Add(combobox_WriteDotOutput, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//DotOutputFile
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_DotOutputFile, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//DotPrecision
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		ExportConfig->SetConfigurationElement(wxT("DotPrecision"),checkbox_DotPrecision->GetValue(),combobox_DotPrecision->GetStringSelection());
		elemsizer->Add(combobox_DotPrecision, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
		//DotTitle
		elemsizer = new wxBoxSizer(wxHORIZONTAL);
		...
		elemsizer->Add(Textbox_DotTitle, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 10);
		Gridpanel->Add(elemsizer,0, wxEXPAND);
	...
	elemsizer = new wxBoxSizer(wxHORIZONTAL);
	//buttons
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_CTL_LOAD, wxT( "Load CTL File" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_CTL_SAVE, wxT( "SAVE CTL File" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_CTL_CLEAR, wxT( "CLEAR TextBox" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_CTL_CHECK, wxT( "Check CTL " ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
	elemsizer = new wxBoxSizer(wxHORIZONTAL);
	//textbox
	...
	elemsizer->Add(Textbox_steadystate, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_ADD, wxT( "Add" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_REMOVE, wxT( "Remove" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_CLEAR, wxT( "Clear" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_CHECK, wxT( "Check" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_LOAD, wxT( "Load" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_STEADYSTATE_SAVE, wxT( "Save" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
	//elemsizer = new wxBoxSizer(wxVERTICAL);
	//m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
	...
	elemsizer->Add(ListBox_transiente, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
	...
	elemsizer->Add(Textbox_transiente, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	...
	elemsizer->Add(Textbox_transiente_time, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_ADD, wxT( "Add" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_REMOVE, wxT( "Remove" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_CLEAR, wxT( "Clear" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_CHECK, wxT( "Check" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_LOAD, wxT( "Load" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	elemsizer->Add(new wxButton( m_pcNotebookPage, SP_ID_BUTTON_TRANSIENTE_SAVE, wxT( "Save" ) ), 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);
	m_pcPageSizer->Add(elemsizer, 0, wxTOP | wxBOTTOM , 5);
