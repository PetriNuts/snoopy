...
//////////////////////////////////////////////////////////////////////
#ifndef __SP_DLG_SORTDIVIDENODES_H__
#define __SP_DLG_SORTDIVIDENODES_H__
...
class SP_DLG_DivideNodes: public wxDialog, public SP_Error
{
private:
DECLARE_EVENT_TABLE()
DECLARE_CLASS(SP_DLG_DivideNodes)
protected:
	wxStaticText* m_text;
	wxSpinCtrl* m_number;
	wxRadioBox* m_choice;
	...
	void DoApply();
public:
	SP_DLG_DivideNodes(SP_DS_Graph *p_graph, unsigned int p_netNumber, SP_ListGraphic* p_graphics, wxWindow *p_parent,
			const wxString& p_title = wxT("Divide Nodes"));
	virtual ~SP_DLG_DivideNodes();
...
#endif // __SP_DLG_SORTDIVIDENODES_H__
