...
*/
//////////////////////////////////////////////////////////////////////
#ifndef __SP_DLG_DirSIMULATION__
#define __SP_DLG_DirSIMULATION__
...
class SP_DLG_DShowAllModelView;

class SP_DLG_DirSimulation : public SP_DLG_BaseSimulation
{
protected:
	// Current Graph
...
protected:
	...
	std::list<SP_DLG_DShowAllModelView*> m_pcExternalWindows;
...
public:
	...
	void RemoveExternalWindow(SP_DLG_DShowAllModelView* p_pcWindow)
	{
...
protected:
	...
	DECLARE_CLASS(SP_DLG_DirSimulation)
public:
	SP_DLG_DirSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText = wxT(""), wxString p_sTitle = wxT("Simulation controls"), long p_nStyle = wxDEFAULT_DIALOG_STYLE);

	virtual ~SP_DLG_DirSimulation();
...
#endif // __SP_DLG_DirSimulation__
