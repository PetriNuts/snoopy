...
#include "sp_gui/dialogs/SP_DLG_ColShowAllModelViewh.h"
...
#endif
IMPLEMENT_CLASS(SP_DLG_DirColorSimulation, SP_DLG_BaseSimulation)
...
BEGIN_EVENT_TABLE(SP_DLG_DirColorSimulation, SP_DLG_BaseSimulation)

EVT_BUTTON(SP_ID_BUTTON_START_SIMULATION, SP_DLG_DirColorSimulation::OnStartAbortSimulation)

EVT_BUTTON(SP_ID_BUTTON_SIMULATION_PROPERTIES, SP_DLG_DirColorSimulation::OnSimulationProperties)

EVT_BUTTON(wxID_CANCEL, SP_DLG_DirColorSimulation::OnDlgCancel)

EVT_GRID_CELL_LEFT_DCLICK(SP_DLG_DirColorSimulation::OnColourClick)

EVT_GRID_LABEL_LEFT_DCLICK(SP_DLG_DirColorSimulation::OnLabelDClick)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_IN, SP_DLG_DirColorSimulation::OnPlotZoomH_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_H_OUT, SP_DLG_DirColorSimulation::OnPlotZoomH_Out)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_IN, SP_DLG_DirColorSimulation::OnPlotZoomV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_V_OUT, SP_DLG_DirColorSimulation::OnPlotZoomV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_IN, SP_DLG_DirColorSimulation::OnPlotZoomHV_In)
EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_HV_OUT, SP_DLG_DirColorSimulation::OnPlotZoomHV_Out)

EVT_BUTTON(SP_ID_BUTTON_PLOT_ZOOM_CENTRAL, SP_DLG_DirColorSimulation::OnPlotZoomCentral)

EVT_BUTTON(SP_ID_BUTTON_PLOT_SAVE_AREA, SP_DLG_DirColorSimulation::OnPlotSaveArea)

EVT_BUTTON(SP_ID_BUTTON_DIRECT_EXPORT_PROPERTIES, SP_DLG_DirColorSimulation::OnDirectExportProperties)
EVT_BUTTON(SP_ID_BUTTON_LOAD_DATA, SP_DLG_DirColorSimulation::OnLoadData)

EVT_BUTTON(SP_ID_PRINT, SP_DLG_DirColorSimulation::OnPrint)


EVT_TIMER(SP_ID_TIMER_UPDATE_DIALOG, SP_DLG_DirColorSimulation::OnTimer)

EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_PROPERTY_SIZER, SP_DLG_DirColorSimulation::OnCollapsePropertySizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_SETS_SIZER, SP_DLG_DirColorSimulation::OnCollapseSetsSizer)
EVT_COLLAPSIBLEPANE_CHANGED(SP_ID_COLLAPSEPANEL_DIRECT_EXPORT_SIZER, SP_DLG_DirColorSimulation::OnCollapseDirectExportSizer)
EVT_BUTTON(SP_ID_BUTTON_SHOW_SELECTED_VIEWS, SP_DLG_DirColorSimulation::OnOpenSelectedGraphViews)
EVT_BUTTON(SP_ID_BUTTON_SHOW_ALL_VIEWS, SP_DLG_DirColorSimulation::OnOpenAllViewsSeparately)
EVT_BUTTON(SP_ID_BUTTON_ADD_NEW_VIEW, SP_DLG_DirColorSimulation::OnAddingNewModalView)
EVT_BUTTON(SP_ID_BUTTON_REMOVE_VIEWS, SP_DLG_DirColorSimulation::OnRemovingModalViews)

END_EVENT_TABLE()

SP_DLG_DirColorSimulation::SP_DLG_DirColorSimulation(SP_DS_Graph* p_pcGraph, wxWindow* p_pcParent, wxString p_sHelpText, wxString p_sTitle, long p_nStyle) :
...

{
	...
	m_pcXAxisChoices[wxT("Place")] = &m_asColPlaceNames;
	//m_pcXAxisChoices[wxT("Place")] = &m_msUncoloredPlaceNames;
	...
	Bind(wxEVT_CLOSE_WINDOW, &SP_DLG_DirColorSimulation::OnCloseWindow, this);
}

void SP_DLG_DirColorSimulation::OnInitDialog(wxInitDialogEvent& event)
{
...
void SP_DLG_DirColorSimulation::SetMinimalLayout()
{
...
void SP_DLG_DirColorSimulation::SimulatorLogFunction(spsim::LogLevel  p_nLogLevel, const std::string&  p_sLogMsg)
{
	switch (p_nLogLevel)
	{
...
void SP_DLG_DirColorSimulation::OnCollapsePropertySizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirColorSimulation::OnCollapseSetsSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}

void SP_DLG_DirColorSimulation::OnCollapseDirectExportSizer(wxCollapsiblePaneEvent& event)
{
	Layout();
}


void SP_DLG_DirColorSimulation::OnOpenSelectedGraphViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColorSimulation::RefreshCurrentExternalView(int p_nCurveIndex, wxString p_nColor, int p_nLineWidth, int p_nLineStyle)
{
...
void SP_DLG_DirColorSimulation::OnAddingNewModalView(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColorSimulation::OnRemovingModalViews(wxCommandEvent& p_cEvent) {
...
void SP_DLG_DirColorSimulation::OnEditXAxis(wxWindow *p_pcExternalWindowDialog) {
	CHECK_POINTER(m_pcCurrentTablePlot, return);
...
void SP_DLG_DirColorSimulation::OnExportClicked(wxWindow *p_pcExternalWindowDialog, int p_nSelection) {
	if (p_nSelection == 0) {
		OnExportToCSV();
	}
}

bool SP_DLG_DirColorSimulation::CreateViewerDataFromRegex(SP_DS_Metadata* p_pcView)
{
	...
	if (l_RegEx.Compile(l_RegExString)) {
		...
		if (l_sElementType.IsSameAs(wxT("Place"))) {
			if (l_RegExOutputType == wxT("Unfolded")) {
				for (unsigned int l_nRow = 0; l_nRow < m_ArrayUncolPlaces.GetCount(); l_nRow++)
				{
					wxString l_sName = m_ArrayUncolPlaces[l_nRow];
					...
					if (match) {
						...
						{
							l_sCurveColor = SP_DLG_DirColorSimulation::GetColourString(l_nPosition);
						}
...
bool SP_DLG_DirColorSimulation::LoadViewerData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView, wxArrayString& p_asPlaces)
{
	wxString l_sName;
	...
	for (unsigned int i = 0; i < m_asColPlaceNames.size(); i++) {
		m_ArrayColPlaces.Add(m_asColPlaceNames[i]);
	}
...
void SP_DLG_DirColorSimulation::LoadData(SP_DS_ResultViewer* p_pcViewer, SP_DS_Metadata* p_pcView)
{
...
void SP_DLG_DirColorSimulation::LoadData(bool p_bCreateNewTree)
{
...
void SP_DLG_DirColorSimulation::LoadSets()
{
...
void SP_DLG_DirColorSimulation::LoadParameters()
{
...
void SP_DLG_DirColorSimulation::OnColourClick(wxGridEvent& p_cEvent)
{
}

void SP_DLG_DirColorSimulation::OnLabelDClick(wxGridEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::AddNewMarkingSet(const wxString& p_sMarkingSetName, const int& p_nRow)
{
...
SP_DS_ColListAttribute* SP_DLG_DirColorSimulation::GetOneMakingAttribute()
{
	SP_DS_Nodeclass* l_pcNodeclass = m_pcGraph->GetNodeclass(SP_DS_CONTINUOUS_PLACE);
...
bool SP_DLG_DirColorSimulation::IsMarkingSetNameExist(const wxString& p_sName)
{
...
void SP_DLG_DirColorSimulation::OnModifyConstantSets(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnDlgCancel(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnCloseWindow(wxCloseEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnDirectExportProperties(wxCommandEvent& p_cEvent)
{
	SP_DLG_StDirectExportProperties* l_pcDlg = new SP_DLG_StDirectExportProperties(SP_ST_SIM_EXPORT_CSV_EDIT_DLG_DIRECT, this, &m_sExportFilename, &m_nExportSpacer, &m_bCompressExact,&m_bAllTracesFuzzy);

	l_pcDlg->ShowModal();

	l_pcDlg->Destroy();
}
void SP_DLG_DirColorSimulation::OnSimulationProperties(wxCommandEvent& p_cEvent)
{
	...
	SP_DLG_ColSimulationProperties* l_pcDlg;

	l_pcDlg = new SP_DLG_ColSimulationProperties(m_pcMainSimulator, this);
...
wxColour SP_DLG_DirColorSimulation::GetNodeColour(SP_DS_Node* p_pcNode)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomH_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomH_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomHV_In(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomHV_Out(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotZoomCentral(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::OnPlotSaveArea(wxCommandEvent& p_cEvent)
{
	/*if (m_pcCurrentTablePlotType == SP_TABLE_PLOT_TYPE_PLOT)
	{
...
wxBitmap SP_DLG_DirColorSimulation::GetEnlargeBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColorSimulation::GetShrinkBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColorSimulation::GetZoomInBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxBitmap SP_DLG_DirColorSimulation::GetZoomOutBitmap()
{
#if defined(__WXMSW__) || defined(__WXPM__)
...
wxString SP_DLG_DirColorSimulation::GetSpacer(int p_nSpacer)
{
...
void SP_DLG_DirColorSimulation::OpenExportFile()
{
...
void SP_DLG_DirColorSimulation::CloseExportFile()
{
	if (m_pcCurrentTablePlot)
	{
...
void SP_DLG_DirColorSimulation::OnExportToCSV()
{
...
void SP_DLG_DirColorSimulation::LoadResults()
{
...
void SP_DLG_DirColorSimulation::OnLoadData(wxCommandEvent& p_cEvent)
{
	...
	if (!l_sFilename.empty())
	{
		...
		/*if (l_pcImport->ReadFile(l_sFilename, m_pcMainSimulator))
		{
			...
			//Update();
			InitializeSimulator();
			m_pcMainSimulator->CSetGeneratedResultPointsCount(l_pcImport->GetOutputStepCount());
			if (l_pcImport->GetClassName() == wxT("Place"))
			{
				m_pcMainSimulator->CGetResultMatrix() = l_pcImport->GetResults();
			}
			else
			{
				m_pcMainSimulator->CGetRateResultMatrix() = l_pcImport->GetResults();
			}
			LoadResults();
		}*/
...
SP_DLG_DirColorSimulation::~SP_DLG_DirColorSimulation()
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirColorSimulation::OnPrint(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::InitializeViews()
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
	long l_nPos = 0;
...
void SP_DLG_DirColorSimulation::OpenViewInSeparateWindow(SP_DS_Metadata* p_pcModelView)
{
	//check if a view with the same name is already opened
	for (auto l_itWindow : m_pcExternalWindows)
	{
	...
	SP_DLG_ColShowAllModelView* l_pcShowModelViewsDlg = new SP_DLG_ColShowAllModelView(this, p_pcModelView, m_pcGraph);
...
void SP_DLG_DirColorSimulation::OnOpenAllViewsSeparately(wxCommandEvent& p_cEvent)
{
...
void SP_DLG_DirColorSimulation::RefreshExternalWindows()
{
	for (auto l_itWindow : m_pcExternalWindows)
	{
		if (l_itWindow != NULL)
...
SP_DS_Metadata* SP_DLG_DirColorSimulation::CreateNewView(const wxString& p_sName, bool p_bCloneCurrent)
{
	SP_DS_Metadataclass* l_pcMetadataclass;
...
bool SP_DLG_DirColorSimulation::IsViewNameExist(const wxString& p_sViewName)
{
...
void SP_DLG_DirColorSimulation::ChangeCurrentView(SP_DS_Metadata* p_pcView)
{
	//Save the current view
	//SaveCurrentView();
...
void SP_DLG_DirColorSimulation::ChangeViewTo(SP_DS_Metadata* p_pcView)
{
...
SP_DS_Metadata* SP_DLG_DirColorSimulation::FindView(const wxString& p_sViewName)
{
	wxString l_sName;
	SP_DS_Metadataclass* l_pcMetadataclass;
...
void SP_DLG_DirColorSimulation::SetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName, const wxString& p_sValue)
{
	CHECK_POINTER(p_pcView, return);
...
wxString SP_DLG_DirColorSimulation::GetViewAttributeValue(SP_DS_Metadata* p_pcView, const wxString& p_sAttributeName)
{
...
wxString SP_DLG_DirColorSimulation::GetColourString(unsigned int p_nIndex)
{
...
void SP_DLG_DirColorSimulation::AddGuiOption2Simulator()
{
...
int SP_DLG_DirColorSimulation::LoadSimulatorProperties()
{
...
void SP_DLG_DirColorSimulation::SaveSimulatorProperties()
{
	SP_DS_Metadata* l_pcSimProp = *(m_pcGraph->GetMetadataclass(wxT("Simulation Properties"))->GetElements()->begin());
	SP_DS_Attribute* l_pcAttr = NULL;
...
void SP_DLG_DirColorSimulation::LoadNodeColours(const wxString& p_nNodeName, SP_VectorString& p_asColours)
{
...
void SP_DLG_DirColorSimulation::UpdateChoices()
{
	m_choices.clear();
	SP_DS_Metadataclass* mc = m_pcGraph->GetMetadataclass(SP_DS_META_CONSTANT);
	if (mc)
...
void SP_DLG_DirColorSimulation::StartSimulation()
{
	DoStartSimulation();
}
