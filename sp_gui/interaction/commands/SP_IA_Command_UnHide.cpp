// SP_IA_Command_UnHide.cpp: Implementierung der Klasse SP_IA_Command_UnHide.
//
//////////////////////////////////////////////////////////////////////

#include "SP_IA_Command_UnHide.h"

//////////////////////////////////////////////////////////////////////
// Konstruktion/Destruktion
//////////////////////////////////////////////////////////////////////

SP_IA_Command_UnHide::SP_IA_Command_UnHide()
: SP_IA_Command(SP_IA_CMD_UNHIDE, wxT("Command: UnHide <Default Name>"), false, false),
m_pcCommandHistory(0)
{ }

SP_IA_Command_UnHide::SP_IA_Command_UnHide(const wxString& p_sName, bool p_bHasConfig, bool p_bCanUndo)
: SP_IA_Command(SP_IA_CMD_UNHIDE, p_sName, p_bHasConfig, p_bCanUndo),
m_pcCommandHistory(0)
{ }
...
SP_IA_Command*
SP_IA_Command_UnHide::Copy(bool p_bTryInit) {
	SP_IA_Command_UnHide* l_pcResult = new SP_IA_Command_UnHide(GetName(), HasConfig(), CanUndo());
...
bool
SP_IA_Command_UnHide::Do(SP_ListData* p_pcData) {
	...
	m_pcCommandHistory = new SP_CMD_Edit(SP_CMD_UNHIDE, &l_pcGraphics);
	//...and executing it.
