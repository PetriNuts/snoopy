...
#if !defined(__SP_IA_COMMAND_HIDE_H__)
#define __SP_IA_COMMAND_HIDE_H__
...
class SP_IA_Command_Hide : public SP_IA_Command {

private:

protected:
	//last executed hide (for later undo)
	SP_CMD_Edit *m_pcCommandHistory;

public:
	SP_IA_Command_Hide();
	SP_IA_Command_Hide(const wxString& p_sName, bool p_bHasConfig = false, bool p_bCanUndo = true);
	virtual ~SP_IA_Command_Hide();
...
#endif // !defined(__SP_IA_COMMAND_HIDE_H__)
