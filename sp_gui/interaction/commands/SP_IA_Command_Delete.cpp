// SP_IA_Command_Delete.cpp: Implementierung der Klasse SP_IA_Command_Delete.
//
//////////////////////////////////////////////////////////////////////

#include "SP_IA_Command_Delete.h"

//////////////////////////////////////////////////////////////////////
// Konstruktion/Destruktion
//////////////////////////////////////////////////////////////////////

SP_IA_Command_Delete::SP_IA_Command_Delete()
: SP_IA_Command(SP_IA_CMD_DELETE, wxT("Command: Delete <Default Name>"), false, false),
m_pcCommandHistory(0)
{ }

SP_IA_Command_Delete::SP_IA_Command_Delete(const wxString& p_sName, bool p_bHasConfig, bool p_bCanUndo)
: SP_IA_Command(SP_IA_CMD_DELETE, p_sName, p_bHasConfig, p_bCanUndo),
m_pcCommandHistory(0)
{ }
...
SP_IA_Command*
SP_IA_Command_Delete::Copy(bool p_bTryInit) {
	SP_IA_Command_Delete* l_pcResult = new SP_IA_Command_Delete(GetName(), HasConfig(), CanUndo());
...
bool
SP_IA_Command_Delete::Do(SP_ListData* p_pcData) {

	//calculating the elements to delete...
	...
	//collecting graphic objects of the elements to delete, ...
	...
	m_pcCommandHistory = new SP_CMD_Edit(SP_CMD_DELETE, &l_pcGraphics);
	//...and executing it.
